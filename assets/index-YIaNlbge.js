...
`},Ep={i:Qf,sl:Gf,t:Kf,a:Xf,g:Yf,k:Zf,d:bf,st:tp,v:np,s:ep,f:rp,l:lp,da:op,dl:ip,z:up,m:sp,w:ap,cv:cp,av:dp,tr:fp,ac:pp,sc:mp,nv:vp,fr:hp,sb:gp,hd:yp,mp:Sp,op:wp,ek:kp,nl:Tp,im:_p,pt:Cp,pf:Pp,sa:xp},Rp={ques:"Что такое GIT",result:`
...
`},Tm={i:Xp,p:Yp,e:Zp,a:bp,b:tm,s:nm,sa:em,r:rm,k:lm,u:om,v:im,f:um,c:sm,pr:am,q:cm,sp:dm,g:fm,cc:pm,fl:mm,z:vm,tr:hm,td:gm,sg:ym,br:Sm,ct:wm,m:km},_m={ques:"Что такое React?",result:`
...
`},Pm={ques:"Что такое серверный рендеринг (Server-Side Rendering)",result:`
...
`},xm={ques:"Перечислите преимущества серверного рендеринга",result:`
...
`},i:_m,h:Cm,sr:Pm,pr:xm,li:Em,ah:Rm,tt:Lm,r:Mm,k:$m,p:Nm,c:Dm,q:qm,t:Om,b:Im,j:zm,s:jm,f:Hm,y:Am,m:Fm,d:Um,z:Wm,n:Jm,u:Bm,e:Vm,a:Qm,ma:Gm,de:Km,w:Xm,hp:Ym,bb:Zm,pa:bm,l:tv,su:nv,fi:ev,uu:rv,o:lv,sf:ov,rx:iv,rc:uv,ss:sv,mw:av,rd:cv,st:dv,rp:fv},mv={ques:"Что такое TypeScript",result:`
...
`},_v={ques:" Что такое внешние объявления переменных (ambient declaration) ",result:`
...
`},Cv={ques:"Абстрактный класс в TypeScript",result:`
...
`},Pv={ques:" Какие элементы ООП поддерживаются в TypeScript",result:`
...
`},xv={ques:"Модификаторы доступа в TypeScript",result:`
...
`},i:mv,s:vv,p:hv,t:gv,d:yv,f:Sv,r:wv,o:kv,k:Tv,w:_v,a:Cv,q:Pv,m:xv,e:Ev,n:Rv,ni:Lv,v:Mv,g:$v,l:Nv,x:Dv,j:qv,y:Ov,u:Iv},jv={ques:"Отличие компилятора от интерпретатора",result:`
	...
	требуют компиляции.
`},Hv={ques:"Что такое прогрессивный рендеринг",result:`
...
`},Fv={ques:"Что происходит при введение запроса в строку",result:`
...
`},Uv={ques:"Кроссбраузерность",result:`
...
`},Wv={ques:"Чем отличаются PUT- и POST-запросы",result:`
...
`},Jv={ques:"Что такое OSI модель",result:`
...
`},Bv={ques:"Поток документа",result:`
...
`},Vv={ques:"Разница между адаптивным и отзывчивым дизайном",result:`
...
`},Qv={ques:" Разница между Progressive Enhancement и Graceful Degradation",result:`
...
`},Gv={ques:"Что такое Веб-компоненты и какие технологии в них используются",result:`
...
`},Xv={ques:"RESTful api",result:`
	...
	его снова у сервера.
`},Yv={ques:"Принципы REST-архитектуры",result:`
...
`},Zv={ques:"Разница между layout, painting и compositing",result:`
...
`},bv={ques:"Чем отличается dev-сборник от prod",result:`
...
`},th={ques:"Что такое Flash Of Unstyled Content (FOUC)? Как его избежать",result:`
...
`},nh={ques:"History API в браузере",result:`
...
`},eh={ques:"Что такое codemod",result:`
...
`},rh={ques:"Что такое веб-хранилище (web storage)",result:`
...
`},lh={ques:"Разница между cookie, sessionStorage и localStorage",result:`
...
`},oh={ques:"Способы уменьшения времени загрузки веб-страницы",result:`
...
`},ih={ques:"Core Web Vitals и метрики",result:`
...
`},uh={ques:"Разница между preload, prefetch, preconnect и prerender",result:`
...
`},sh={ques:"Для чего нужен паттерн PRPL",result:`
...
`},ch={ques:"Из чего состоит HTTP-запрос",result:`
...
`},dh={ques:"Разница между HTTP и HTTPS",result:`
...
`},fh={ques:"Разница между HTTP/1 и HTTP/2",result:`
...
`},ph={ques:"Как работает мультиплексирование в HTTP/2",result:`
...
`},mh={ques:"Что такое “трехстороннее рукопожатие” (Triple handshake)",result:`
...
`},vh={ques:"Разница между PUT и POST-запросами",result:`
...
`},hh={ques:"Разница между протоколами TCP и UDP",result:`
...
`},gh={ques:"Что такое WebSocket",result:`
...
`},yh={ques:"Разница между Long-Polling, Websockets и Server-Sent Events",result:`
...
`},Sh={ques:"Как работает JSONP",result:`
...
`},wh={ques:"Что такое Service Workers",result:`
...
`},kh={ques:"Что такое Web Workers",result:`
...
`},Th={ques:"Что такое Web Worklet",result:`
...
`},_h={ques:"Механизм установки сеанса между клиентом и сервером",result:`
...
`},Eh={ques:"Разница между host и domain",result:`
...
`},Rh={ques:"Разница между URI и URL",result:`
...
`},Lh={ques:"Разница между монолитной и микросервисной архитектурами",result:`
...
`},Mh={ques:"Опишите способы оптимизации SVG-файлов",result:`
...
`},$h={0:{ques:"Что такое HTTP cookie? Для чего они используются",result:`
...
`},ki:jv,i:Hv,p:Av,z:Fv,c:Uv,pt:Wv,o:Jv,d:Bv,m:Vv,g:Qv,w:Gv,r:Kv,f:Xv,a:Yv,l:Zv,jf:bv,u:th,h:nh,cm:eh,v:rh,k:lh,s:oh,x:ih,j:uh,e:sh,t:ah,b:ch,n:dh,t2:fh,w2:ph,ts:mh,pu:vh,d2:hh,ws:gh,dt:yh,jp:Sh,in:{ques:"Что такое IndexedDB в браузере? Преимущества IndexedDB",result:`
...
`},sw:wh,ww:kh,w5:Th,dd:_h,ap:Ch,cd:Ph,ip:xh,hd:Eh,ur:Rh,qq:Lh,sv:Mh},Nh={ques:"Что такое DOM?",result:`
...
`},qh={ques:"Методы JavaScript для поиска элементов на странице",result:`
	...
	6.getElementsByName  
`},Oh={ques:"Свойства для перемещения по dom-дереву",result:`
...
`},zh={ques:"Виды событий Event?",result:`
...
`},jh={ques:"media выражения в JavaScript",result:`
...
`},Hh={ques:"event.target и event.currentTarget",result:`
...
`},Ah={ques:"события load и DOMContentLoaded",result:`
...
`},Fh={ques:"Метод EventTarget.addEventListener()",result:`
...
`},Wh={ques:"Как узнать об использовании метода event.preventDefault()?",result:`
...
`},Jh={ques:"Intersection Observer",result:`
...
`},Vh={ques:"Типы данных в JavaScript",result:`
...
`},Gh={ques:"Разница между function declaration и function expression",result:`
...
`},Kh={ques:"Типы таймеров в JavaScript",result:`
...
`},Xh={ques:"Поднятие (Hoisting)",result:`
...
`},Yh={ques:"Область видимости (Scope)",result:`
...
`},tg={ques:"Что такое чистая функция",result:`
...
`},ng={ques:"Почему в JS функции называют объектами первого класса",result:`
...
`},eg={ques:"Псевдомассив arguments",result:`
...
`},rg={ques:"Разница между host-объектами и нативными объектами",result:`
	...
	в любом окружении.
`},lg={ques:"События указателя (Pointer Events)",result:`
...
`},og={ques:"Прототипное наследование",result:`
...
`},ug={ques:"Объектная обертка (Wrapper Objects)",result:`
...
`},sg={ques:"Проверить, является ли значение массивом",result:`
	Array.isArray(yourVariable)
	val.constructor === Array
	Object.prototype.toString.call(val) === '[object Array]'
`},ag={ques:"boxing/unboxing",result:`
...
`},cg={ques:"Разница между оператором in и методом .hasOwnProperty()",result:`
...
`},dg={ques:"Разница между глубокой (deep) и поверхностной (shallow) копиями",result:`
	...
	Для создания глубокой копии объекта:
		...
		-Рекурсивно
		-Библиотеки
`},fg={ques:"Цепочка вызовов функций (chaining)",result:`
...
`},pg={ques:"Что такое необъявленная переменная",result:`
...
`},mg={ques:"Как передаются параметры в функцию: по ссылке или по значению",result:`
...
`},vg={ques:"Что такое прототип объекта в JavaScript",result:`
...
`},hg={ques:"Как работает метод Object.create()",result:`
...
`},gg={ques:"Object.freeze() и Object.seal()",result:`
...
`},yg={ques:"Плюсы и минусы использования use strict",result:`
	Плюсы:
...
`},Sg={ques:"Плюсы и минусы иммутабельности",result:`
	Плюсы:
...
`},wg={ques:"Типы ОБЪЕКТОВ JavaScript",result:`
	-Строковые объекты.
	-Числовые объекты
	-Логические объекты
	-Объектные литералы
	-Массивы 
`},kg={ques:"Типы ошибок в JavaScript",result:`
...
`},Tg={ques:"Разница между typeof и instanceof?",result:`
...
`},_g={ques:"JavaScript статически, или динамически типизированный язык",result:`
...
`},Eg={ques:"Типы утечек памяти в JavaScript",result:`
...
`},Rg={ques:"Разница между примитивом и объектом",result:`
...
`},Lg={ques:"Почему typeof null возвращает object",result:`
...
`},Mg={ques:"Зачем нужен конструктор Proxy?",result:`
...
`},$g={ques:"Разница между синхронными и асинхронными функциями",result:`
...
`},Dg={ques:"Что такое same-origin policy в контексте JavaScript",result:`
...
`},Og={ques:"Что такое промисы (Promises)",result:`
...
`},Ig={ques:"В каких состояниях может пребывать Promise)",result:`
...
`},zg={ques:"Плюсы и минусы использовании Ajax",result:`
	Плюсы:
...
`},jg={ques:"Подходы при работе с асинхронным кодом",result:`
...
`},Hg={ques:"Преимущества использовании промисов вместо колбэков",result:`
...
`},Ag={ques:"Что такое callback-функция? Что такое Callback Hell",result:`
...
`},Fg={ques:"Что такое async/await",result:`
...
`},Ug={ques:"Плюсы и минусы асинхронного программирования",result:`
	Плюсы:
...
`},Wg={ques:"Что такое генераторы? Когда стоит использовать генераторы",result:`
...
`},Jg={ques:"Что такое дескрипторы свойств объектов",result:`
...
`},Vg={ques:"WeakMap и WeakSet",result:`
...
`},Qg={ques:"Что такое temporal dead zone",result:`
...
`},Gg={0:{ques:"Разница между null и undefined",result:`
...
`},i:Nh,n:Dh,m:qh,c:Oh,b:Ih,e:zh,s:jh,t:Hh,l:Ah,q:Fh,x:Uh,h:Wh,o:Jh,u:Bh,td:Vh,st:Qh,f:Gh,ti:Kh,p:Xh,sc:Yh,z:Zh,th:bh,mn:tg,fc:ng,pm:eg,hn:rg,pe:lg,pl:og,na:ig,w:ug,ar:sg,bu:ag,ih:cg,ds:dg,ch:fg,uv:pg,af:mg,po:vg,oc:hg,fs:gg,ms:yg,im:Sg,to:wg,er:kg,tt:Tg,sd:_g,re:Cg,pf:Pg,es:xg,lm:Eg,ob:Rg,no:Lg,pr:Mg,as:$g,aj:Ng,sp:Dg,ma:qg,ps:Og,yt:Ig,da:zg,ac:jg,pp:Hg,cf:Ag,aa:Fg,p0:Ug,g:Wg,k:Jg,q1:Bg,wm:Vg,tz:Qg},Kg={ques:"Основные принципы ООП",result:`
...
`},Xg={ques:"Что такое SOLID",result:`
...
`},Yg={ques:"Разница между классовым и прототипным наследованием",result:`
...
`},Zg={ques:"Однонаправленный поток данных и двусторонняя связь данных",result:`
...
`},ty={ques:"Что такое каррирование (Currying)",result:`
...
`},ny={ques:"Статический метод класса (static)",result:`
...
`},ey={ques:"Типы паттернов в ООП",result:`
...
`},ry={ques:"Как работает механизм прототипов в JavaScript",result:`
...
`},ly={ques:"Разница между императивным и декларативным подходами программирования",result:`
...
`},oy={ques:"Что такое реактивное программирование",result:`
...
`},iy={ques:"Разница между агрегацией и композицией",result:`
...
`},uy={i:Kg,s:Xg,p:Yg,d:Zg,m:bg,k:ty,t:ny,n:ey,v:ry,x:ly,r:oy,e:iy},sy={ques:"Виды тестирования",result:`
...
`},ay={ques:"Fake в unit тестировании",result:`
...
`},cy={ques:"Stub в unit тестировании",result:`
...
`},dy={ques:"Mock в unit тестировании?",result:`
...
`},fy={ques:"White/Black/Grey Box-тестирование?",result:`
...
`},py={ques:"Что такое Quality Gates",result:`
...
`},my={ques:"Разница между TDD и BDD",result:`
...
`},vy={ques:"UI-тестирование",result:`
...
`},hy={ques:"Как можно оценить качество тестирования",result:`
...
`},gy={ques:"Принцип FIRST в тестировании",result:`
...
`},yy={v:sy,f:ay,s:cy,m:dy,b:fy,g:py,t:my,u:vy,e:hy,i:gy},Sy={ques:"Метрики в программировании",result:`
...
`},ky={ques:"Что такое БЭМ-сущность?",result:`
...
`},_y={m:Sy,i:wy,e:ky,p:Ty},Cy={ques:"Что такое vue?",result:"vue - это ..."},Py={e:Cy},Nr={html:Ep,css:Tm,methodology:_y,react:pv,type_script:zv,web:$h,java_script:Gg,git:Kp,oop:uy,testing:yy,vue:Py},xy=Object.keys(Nr),Wo={html:"HTML и вёрстка",git:"GIT",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web",vue:"Vue"},Ey=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>{const e=r=>{r.target.tagName==="BUTTON"&&(t(r.target.id),n(!1))};return N.jsx("div",{className:Xu.dropDown,children:N.jsx("ul",{className:Xu.dropDown_list,onClick:e,children:xy.map(r=>N.jsx("li",{children:N.jsx(cc,{text:Wo[r],id:r,position:"menu"})},Wo[r]))})})}),Ry=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>N.jsx("div",{className:Ku.menu_nav,children:N.jsx("ul",{className:Ku.menu_nav_list,children:N.jsx(Ey,{setWindowContentName:t,setIsActiveMenu:n})})})),Ly="_list_ques_91ie3_1",My="_window_content__answer_91ie3_5",$y="_window_content_91ie3_5",Ny="_window_content__text_91ie3_20",Dy="_title_page_91ie3_30",qy="_input_search_91ie3_36",Oy="_input_search_input_91ie3_41",Iy="_not_matches_91ie3_53",zy="_button_back_91ie3_58",At={list_ques:Ly,window_content__answer:My,window_content:$y,window_content__text:Ny,title_page:Dy,input_search:qy,input_search_input:Oy,not_matches:Iy,button_back:zy},jy=(t,n)=>{const e=t.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(n))for(let[i,u]of Object.entries(o))JSON.stringify(u).toLowerCase().indexOf(e)!=-1&&r.push([i,u,l]);return r},Hy=(t,n=300)=>{let e=null;return(...r)=>{window.clearTimeout(e),e=setTimeout(()=>{t(...r)},n)}};function Ay({windowContentName:t,setIsActiveMenu:n,setWindowContentName:e}){const[r,l]=vt.useState(null),[o,i]=vt.useState(""),[u,s]=vt.useState(0),d=Hy(y=>{if(y.target){const S=y.target.value.trim().toLowerCase();i(S)}},800),v=()=>{l(null),n(!1),setTimeout(()=>window.scrollTo(0,u),0)},m=vt.useMemo(()=>{const y=w=>{const D=w.target.parentElement.getAttribute("data-name");if(D&&e(D),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?jy(o,Nr):Object.entries(Nr[t]);return N.jsx(kr.Fragment,{children:S.length>0?N.jsx("ol",{className:At.list_ques,onClick:y,children:S.map((w,D)=>{var c;return N.jsx("li",{"data-name":w[2]?w[2]:"",children:N.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+D)})}):N.jsx("div",{className:At.not_matches,children:"Совпадений не найдено"})})},[t,o]),p=vt.useMemo(()=>{var S;const y=Nr[t];if(r)return N.jsxs("article",{className:At.window_content__answer,children:[N.jsx("h1",{children:(S=y==null?void 0:y[r])==null?void 0:S.ques}),N.jsx("div",{className:At.window_content__text,children:N.jsx("p",{children:y==null?void 0:y[r].result})})]})},[t,r]);return N.jsxs("div",{className:At.window_content,children:[!r&&N.jsxs(kr.Fragment,{children:[N.jsx("div",{className:At.input_search,children:N.jsx("input",{className:At.input_search_input,type:"text",onChange:d,placeholder:"Поиск по содержимому всех тем"})}),N.jsx("h1",{className:At.title_page,children:o?"Результат поиска":Wo[t]})]}),r?N.jsxs(kr.Fragment,{children:[N.jsx("button",{className:At.button_back,onClick:v,children:"BACK"}),p]}):m]})}function Fy(){const[t,n]=vt.useState(""),[e,r]=vt.useState(!0),l=()=>{r(!0),n("")};return N.jsx("main",{children:N.jsxs("div",{className:Gu.wrapper,children:[N.jsx("button",{onClick:l,className:Gu.open_menu,children:"MENU"}),!!t&&N.jsx(Ay,{windowContentName:t,setWindowContentName:n,setIsActiveMenu:r}),e&&N.jsx(Ry,{setWindowContentName:n,setIsActiveMenu:r})]})})}Kl.createRoot(document.getElementById("root")).render(N.jsx(kr.StrictMode,{children:N.jsx(Fy,{})}));
