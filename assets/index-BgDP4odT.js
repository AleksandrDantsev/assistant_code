 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function n(C,E){var R=C.length;C.push(E);t:for(;0<R;){var J=R-1>>>1,K=C[J];if(0<l(K,E))C[J]=E,C[R]=K,R=J;else break t}}function e(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var E=C[0],R=C.pop();if(R!==E){C[0]=R;t:for(var J=0,K=C.length,tr=K>>>1;J<tr;){var yn=2*(J+1)-1,kl=C[yn],Sn=yn+1,nr=C[Sn];if(0>l(kl,R))Sn<K&&0>l(nr,kl)?(C[J]=nr,C[Sn]=R,J=Sn):(C[J]=kl,C[yn]=R,J=yn);else if(Sn<K&&0>l(nr,R))C[J]=nr,C[Sn]=R,J=Sn;else break t}}return E}function l(C,E){var R=C.sortIndex-E.sortIndex;return R!==0?R:C.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;t.unstable_now=function(){return o.now()}}else{var i=Date,u=i.now();t.unstable_now=function(){return i.now()-u}}var s=[],d=[],v=1,m=null,p=3,y=!1,S=!1,w=!1,D=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,a=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(C){for(var E=e(d);E!==null;){if(E.callback===null)r(d);else if(E.startTime<=C)r(d),E.sortIndex=E.expirationTime,n(s,E);else break;E=e(d)}}function h(C){if(w=!1,f(C),!S)if(e(s)!==null)S=!0,Sl(T);else{var E=e(d);E!==null&&wl(h,E.startTime-C)}}function T(C,E){S=!1,w&&(w=!1,c(_),_=-1),y=!0;var R=p;try{for(f(E),m=e(s);m!==null&&(!(m.expirationTime>E)||C&&!Et());){var J=m.callback;if(typeof J=="function"){m.callback=null,p=m.priorityLevel;var K=J(m.expirationTime<=E);E=t.unstable_now(),typeof K=="function"?m.callback=K:m===e(s)&&r(s),f(E)}else r(s);m=e(s)}if(m!==null)var tr=!0;else{var yn=e(d);yn!==null&&wl(h,yn.startTime-E),tr=!1}return tr}finally{m=null,p=R,y=!1}}var P=!1,x=null,_=-1,W=5,M=-1;function Et(){return!(t.unstable_now()-M<W)}function ae(){if(x!==null){var C=t.unstable_now();M=C;var E=!0;try{E=x(!0,C)}finally{E?ce():(P=!1,x=null)}}else P=!1}var ce;if(typeof a=="function")ce=function(){a(ae)};else if(typeof MessageChannel<"u"){var ji=new MessageChannel,dc=ji.port2;ji.port1.onmessage=ae,ce=function(){dc.postMessage(null)}}else ce=function(){D(ae,0)};function Sl(C){x=C,P||(P=!0,ce())}function wl(C,E){_=D(function(){C(t.unstable_now())},E)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(C){C.callback=null},t.unstable_continueExecution=function(){S||y||(S=!0,Sl(T))},t.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<C?Math.floor(1e3/C):5},t.unstable_getCurrentPriorityLevel=function(){return p},t.unstable_getFirstCallbackNode=function(){return e(s)},t.unstable_next=function(C){switch(p){case 1:case 2:case 3:var E=3;break;default:E=p}var R=p;p=E;try{return C()}finally{p=R}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(C,E){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var R=p;p=C;try{return E()}finally{p=R}},t.unstable_scheduleCallback=function(C,E,R){var J=t.unstable_now();switch(typeof R=="object"&&R!==null?(R=R.delay,R=typeof R=="number"&&0<R?J+R:J):R=J,C){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=R+K,C={id:v++,callback:E,priorityLevel:C,startTime:R,expirationTime:K,sortIndex:-1},R>J?(C.sortIndex=R,n(d,C),e(s)===null&&C===e(d)&&(w?(c(_),_=-1):w=!0,wl(h,R-J))):(C.sortIndex=K,n(s,C),S||y||(S=!0,Sl(T))),C},t.unstable_shouldYield=Et,t.unstable_wrapCallback=function(C){var E=p;return function(){var R=p;p=E;try{return C.apply(this,arguments)}finally{p=R}}}})(as);ss.exports=as;var qc=ss.exports;/**
 * @license React
...
`},xp={ques:"Способы улучшения производительности веб-страницы при использовании HTML",result:`
	...
	-Ленивая подгрузка 
`},_p={ques:"Основные атрибуты HTML-форм? Как они влияют на отправку данных с веб-страницы",result:`
...
`},Ep={i:Qf,sl:Gf,t:Kf,a:Xf,g:Yf,k:Zf,d:bf,st:tp,v:np,s:ep,f:rp,l:lp,da:op,dl:ip,z:up,m:sp,w:ap,cv:cp,av:dp,tr:fp,ac:pp,sc:mp,nv:vp,fr:hp,sb:gp,hd:yp,mp:Sp,op:wp,ek:kp,nl:Tp,im:Cp,pt:Pp,pf:xp,sa:_p},Rp={ques:"Что такое GIT",result:`
...
`},Np={ques:"Для чего нужна индексация файлов в git",result:`
...
`},Hp={ques:"Как обновить удаленный репозиторий git",result:`
...
`},Jp={ques:"Как отменить слияние веток git",result:`
...
`},Bp={ques:"Как посмотреть все ветки git в репозитории",result:`
...
`},Kp={i:Rp,r:Lp,c:Mp,o:$p,a:Np,v:Dp,u:qp,e:Op,d:Ip,s:zp,m:jp,p:Hp,h:Ap,z:Fp,q:Up,b:Wp,n:Jp,y:Bp,l:Vp,x:Qp,f:Gp},Xp={ques:"Что такое css?",result:`
...
`},dm={ques:"Как с помощью CSS определить, поддерживается ли свойство в браузере?",result:`
	Через CSS директиву под названием @supports.

	@supports (display: flex) {
   		/* Стили */
	}
`},fm={ques:"Глобальные ключевые слова в CSS?",result:`
...
`},Tm={i:Xp,p:Yp,e:Zp,a:bp,b:tm,s:nm,sa:em,r:rm,k:lm,u:om,v:im,f:um,c:sm,pr:am,q:cm,sp:dm,g:fm,cc:pm,fl:mm,z:vm,tr:hm,td:gm,sg:ym,br:Sm,ct:wm,m:km},Cm={ques:"Что такое React?",result:`
	...
	организованным.
`},Pm={ques:"Особенности React",result:`
...
`},_m={ques:"Перечислите преимущества серверного рендеринга",result:`
	...
	стороне сервера.
`},Em={ques:"Что такое линтеры",result:`
	...
	для CSS и Sass.
`},Rm={ques:"Какие архитектурные решения для React вы знаете",result:`
...
`},Lm={ques:"Как выполняется валидация данных в React-приложении",result:`
...
`},Mm={ques:"Что такое Virtual DOM",result:`
...
`},$m={ques:"Атрибут key при рендере?",result:`
...
`},qm={ques:"Жизненный цикл компонентов React",result:`
	1.Инициализация
	2.Монтирование
	3.Обновление
	4.Размонтирование
`},Om={ques:"Что такое Portal",result:`
...
`},Im={ques:"Что такое React хуки",result:`
...
`},Hm={ques:"Что такое React Fiber",result:`
...
`},Am={ques:"Синтетические события в react",result:`
...
`},Fm={ques:"Что такое компонент-переключатель (Switching Component)",result:`
...
`},Um={ques:"Что такое React DOM",result:`
...
`},Wm={ques:"Разница между компонентом и контейнером React",result:`
...
`},Vm={ques:"Что такое предохранители (Error Boundaries)",result:`
...
`},Qm={ques:"Инверсия наследования (Inheritance Inversion)",result:`
...
`},Gm={ques:"Чем управляемые компоненты отличаются от неуправляемых",result:`
...
`},Km={ques:"Разница между классовым и функциональным компонентами",result:`
...
`},Xm={ques:" Разница между useEffect() и componentDidMount()",result:`
...
`},Ym={ques:"Преимущества хуков",result:`
...
`},Zm={ques:"Что такое методы жизненного цикла компонента",result:`
...
`},bm={ques:"Что такое публичный API",result:`
...
`},nv={ques:"Что делает метод shouldComponentUpdate",result:`
	...
	приложения.
`},ev={ques:"Как реализовать однократное выполнение операции при начальном рендеринге?",result:`
...
`},lv={ques:"Что такое реактивность",result:`
...
`},ov={ques:"Лучшие практики безопасности в React",result:`
...
`},iv={ques:"Что такое Redux? Ключевые принципы Redux",result:`
...
`},uv={ques:"Ключевые концепции Redux",result:`
...
`},sv={ques:"Что такое «единственный источник истины» (Single Source of Truth)",result:`
...
`},cv={ques:"Что такое редьюсер (Reducer)",result:`
...
`},dv={ques:"Разница между React State и Redux State",result:`
...
`},fv={ques:"Как выглядит поток данных в Redux-приложении",result:`
...
`},pv={2:{ques:"Разница между рендерингом и монтированием",result:`
...
`},i:Cm,h:Pm,sr:xm,pr:_m,li:Em,ah:Rm,tt:Lm,r:Mm,k:$m,p:Nm,c:Dm,q:qm,t:Om,b:Im,j:zm,s:jm,f:Hm,y:Am,m:Fm,d:Um,z:Wm,n:Jm,u:Bm,e:Vm,a:Qm,ma:Gm,de:Km,w:Xm,hp:Ym,bb:Zm,pa:bm,l:tv,su:nv,fi:ev,uu:rv,o:lv,sf:ov,rx:iv,rc:uv,ss:sv,mw:av,rd:cv,st:dv,rp:fv},mv={ques:"Что такое TypeScript",result:`
	...
	JavaScript.
`},vv={ques:"Назовите особенности TypeScript",result:`
...
`},hv={ques:"Плюсы использования TypeScript?",result:`
	-Более строгий контроль типов.
	-Более читаемый код.
	-Совместимость с JavaScript.
	-Поддерживается многими инструментами.
	-Может улучшить производительность.
`},gv={ques:"Типы в TypeScript?",result:`
...
`},Sv={ques:"Что такое перегрузка функций",result:`
	...
	типа аргумента.
`},wv={ques:"Поддерживает ли TypeScript перегрузку функций",result:`
...
`},kv={ques:"Разница между type и  interface в typescript",result:`
...
`},Tv={ques:"Что такое директивы с тремя наклонными чертами (Triple-Slash Directives), их типы",result:`
...
`},Pv={ques:"Абстрактный класс в TypeScript",result:`
...
`},xv={ques:" Какие элементы ООП поддерживаются в TypeScript",result:`
...
`},_v={ques:"Модификаторы доступа в TypeScript",result:`
...
`},Ev={ques:"Internal Module и External Module",result:`
	...
	различных проектах.
`},Rv={ques:"Перечисление (enum)",result:`
...
`},Mv={ques:"“Объединение” (|) и “Пересечение” (&) typescript",result:`
...
`},Nv={ques:"Какие области видимости доступны в TypeScript",result:`
...
`},Dv={ques:"Что такое .map файл, как и зачем его использовать",result:`
...
`},qv={ques:"Можно ли использовать TypeScript в серверной разработке",result:`
...
`},zv={4:{ques:"Разница между типами void, never и unknown",result:`
...
`},i:mv,s:vv,p:hv,t:gv,d:yv,f:Sv,r:wv,o:kv,k:Tv,w:Cv,a:Pv,q:xv,m:_v,e:Ev,n:Rv,ni:Lv,v:Mv,g:$v,l:Nv,x:Dv,j:qv,y:Ov,u:Iv},jv={ques:"Что такое прогрессивный рендеринг",result:`
...
`},Av={ques:"Что происходит при введение запроса в строку",result:`
...
`},Uv={ques:"Чем отличаются PUT- и POST-запросы",result:`
...
`},Wv={ques:"Что такое OSI модель",result:`
...
`},Jv={ques:"Поток документа",result:`
...
`},Qv={ques:"Что такое Веб-компоненты и какие технологии в них используются",result:`
...
`},Kv={ques:"RESTful api",result:`
	...
	его снова у сервера.
`},Xv={ques:"Принципы REST-архитектуры",result:`
...
`},Yv={ques:"Разница между layout, painting и compositing",result:`
...
`},Zv={ques:"Что такое Flash Of Unstyled Content (FOUC)? Как его избежать",result:`
...
`},th={ques:"Что такое веб-хранилище (web storage)",result:`
...
`},nh={ques:"Разница между cookie, sessionStorage и localStorage",result:`
...
`},eh={ques:"Способы уменьшения времени загрузки веб-страницы",result:`
...
`},rh={ques:"Core Web Vitals и метрики",result:`
...
`},lh={ques:"Разница между preload, prefetch, preconnect и prerender",result:`
...
`},oh={ques:"Для чего нужен паттерн PRPL",result:`
...
`},uh={ques:"Из чего состоит HTTP-запрос",result:`
...
`},sh={ques:"Разница между HTTP и HTTPS",result:`
...
`},ah={ques:"Разница между HTTP/1 и HTTP/2",result:`
...
`},ch={ques:"Как работает мультиплексирование в HTTP/2",result:`
...
`},dh={ques:"Что такое “трехстороннее рукопожатие” (Triple handshake)",result:`
...
`},fh={ques:"Разница между PUT и POST-запросами",result:`
...
`},ph={ques:"Разница между протоколами TCP и UDP",result:`
...
`},mh={ques:"Что такое WebSocket",result:`
...
`},vh={ques:"Разница между Long-Polling, Websockets и Server-Sent Events",result:`
...
`},hh={ques:"Как работает JSONP",result:`
...
`},gh={ques:"Что такое Service Workers",result:`
...
`},yh={ques:"Что такое Web Workers",result:`
...
`},Sh={ques:"Что такое Web Worklet",result:`
...
`},wh={ques:"Механизм установки сеанса между клиентом и сервером",result:`
...
`},Ch={ques:" Что такое IP-адрес",result:`
...
`},Ph={ques:"Разница между host и domain",result:`
...
`},xh={ques:"Разница между URI и URL",result:`
...
`},_h={ques:"Разница между монолитной и микросервисной архитектурами",result:`
...
`},Eh={0:{ques:"Что такое HTTP cookie? Для чего они используются",result:`
...
`},i:jv,p:Hv,z:Av,c:Fv,pt:Uv,o:Wv,d:Jv,m:Bv,g:Vv,w:Qv,r:Gv,f:Kv,a:Xv,l:Yv,u:Zv,h:bv,v:th,k:nh,s:eh,x:rh,j:lh,e:oh,t:ih,b:uh,n:sh,t2:ah,w2:ch,ts:dh,pu:fh,d2:ph,ws:mh,dt:vh,jp:hh,in:{ques:"Что такое IndexedDB в браузере? Преимущества IndexedDB",result:`
...
`},sw:gh,ww:yh,w5:Sh,dd:wh,ap:kh,cd:Th,ip:Ch,hd:Ph,ur:xh,qq:_h},Rh={ques:"Что такое DOM?",result:`
...
`},Mh={ques:"Методы JavaScript для поиска элементов на странице",result:`
	1.querySelector
	2.querySelectorAll
	3.getElementById
	...
	6.getElementsByName  
`},$h={ques:"Свойства для перемещения по dom-дереву",result:`
...
`},Dh={ques:"Виды событий Event?",result:`
...
`},qh={ques:"media выражения в JavaScript",result:`
...
`},Oh={ques:"event.target и event.currentTarget",result:`
...
`},Ih={ques:"события load и DOMContentLoaded",result:`
...
`},zh={ques:"Метод EventTarget.addEventListener()",result:`
...
`},Hh={ques:"Как узнать об использовании метода event.preventDefault()?",result:`
...
`},Jh={ques:"Разница между function declaration и function expression",result:`
...
`},Bh={ques:"Типы таймеров в JavaScript",result:`
...
`},Qh={ques:"Область видимости (Scope)",result:`
...
`},Xh={ques:"Что такое чистая функция",result:`
...
`},Yh={ques:"Почему в JS функции называют объектами первого класса",result:`
...
`},Zh={ques:"Псевдомассив arguments",result:`
...
`},bh={ques:"Разница между host-объектами и нативными объектами",result:`
	...
	в любом окружении.
`},tg={ques:"События указателя (Pointer Events)",result:`
...
`},ng={ques:"Прототипное наследование",result:`
...
`},rg={ques:"Объектная обертка (Wrapper Objects)",result:`
...
`},lg={ques:"Проверить, является ли значение массивом",result:`
	Array.isArray(yourVariable)
	val.constructor === Array
	Object.prototype.toString.call(val) === '[object Array]'
`},og={ques:"boxing/unboxing",result:`
...
`},ig={ques:"Разница между оператором in и методом .hasOwnProperty()",result:`
...
`},ug={ques:"Разница между глубокой (deep) и поверхностной (shallow) копиями",result:`
...
`},ag={ques:"Что такое необъявленная переменная",result:`
...
`},cg={ques:"Как передаются параметры в функцию: по ссылке или по значению",result:`
...
`},dg={ques:"Что такое прототип объекта в JavaScript",result:`
...
`},fg={ques:"Как работает метод Object.create()",result:`
...
`},mg={ques:"Плюсы и минусы использования use strict",result:`
	Плюсы:
...
`},vg={ques:"Плюсы и минусы иммутабельности",result:`
	Плюсы:
...
`},hg={ques:"Типы ОБЪЕКТОВ JavaScript",result:`
	-Строковые объекты.
	-Числовые объекты
	-Логические объекты
	-Объектные литералы
	-Массивы 
`},gg={ques:"Типы ошибок в JavaScript",result:`
...
`},yg={ques:"Разница между typeof и instanceof?",result:`
...
`},Sg={ques:"JavaScript статически, или динамически типизированный язык",result:`
...
`},wg={ques:"Регулярное выражение (Regular Expression)",result:`
...
`},kg={ques:"Что такое полифил (polyfill)",result:`
...
`},Tg={ques:"expression и statement",result:`
...
`},Cg={ques:"Типы утечек памяти в JavaScript",result:`
...
`},Pg={ques:"Разница между примитивом и объектом",result:`
...
`},xg={ques:"Почему typeof null возвращает object",result:`
...
`},_g={ques:"Зачем нужен конструктор Proxy?",result:`
...
`},Eg={ques:"Разница между синхронными и асинхронными функциями",result:`
...
`},Lg={ques:"Что такое same-origin policy в контексте JavaScript",result:`
...
`},Mg={ques:"Разница между микро и макрозадачами в event loop",result:`
...
`},$g={ques:"Что такое промисы (Promises)",result:`
...
`},Ng={ques:"В каких состояниях может пребывать Promise)",result:`
...
`},Dg={ques:"Плюсы и минусы использовании Ajax",result:`
	Плюсы:
...
`},qg={ques:"Подходы при работе с асинхронным кодом",result:`
...
`},Og={ques:"Преимущества использовании промисов вместо колбэков",result:`
...
`},Ig={ques:"Что такое callback-функция? Что такое Callback Hell",result:`
...
`},zg={ques:"Что такое async/await",result:`
...
`},jg={ques:"Плюсы и минусы асинхронного программирования",result:`
	Плюсы:
...
`},Hg={ques:"Что такое генераторы? Когда стоит использовать генераторы",result:`
...
`},Ag={ques:"Что такое дескрипторы свойств объектов",result:`
...
`},Fg={ques:" В чем заключаются особенности геттеров и сеттеров",result:`
...
`},Ug={0:{ques:"Разница между null и undefined",result:`
...
`},i:Rh,n:Lh,m:Mh,c:$h,b:Nh,e:Dh,s:qh,t:Oh,l:Ih,q:zh,x:jh,h:Hh,o:Ah,u:Fh,td:Uh,st:Wh,f:Jh,ti:Bh,p:Vh,sc:Qh,z:Gh,th:Kh,mn:Xh,fc:Yh,pm:Zh,hn:bh,pe:tg,pl:ng,na:eg,w:rg,ar:lg,bu:og,ih:ig,ds:ug,ch:sg,uv:ag,af:cg,po:dg,oc:fg,fs:pg,ms:mg,im:vg,to:hg,er:gg,tt:yg,sd:Sg,re:wg,pf:kg,es:Tg,lm:Cg,ob:Pg,no:xg,pr:_g,as:Eg,aj:Rg,sp:Lg,ma:Mg,ps:$g,yt:Ng,da:Dg,ac:qg,pp:Og,cf:Ig,aa:zg,p0:jg,g:Hg,k:Ag,q1:Fg},Wg={ques:"Основные принципы ООП",result:`
...
`},Jg={ques:"Что такое SOLID",result:`
...
`},Bg={ques:"Разница между классовым и прототипным наследованием",result:`
...
`},Vg={ques:"Однонаправленный поток данных и двусторонняя связь данных",result:`
...
`},Gg={ques:"Что такое каррирование (Currying)",result:`
...
`},Kg={ques:"Статический метод класса (static)",result:`
...
`},Xg={ques:"Типы паттернов в ООП",result:`
...
`},Yg={ques:"Как работает механизм прототипов в JavaScript",result:`
...
`},Zg={ques:"Разница между императивным и декларативным подходами программирования",result:`
...
`},bg={ques:"Что такое реактивное программирование",result:`
...
`},ty={ques:"Разница между агрегацией и композицией",result:`
...
`},ny={i:Wg,s:Jg,p:Bg,d:Vg,m:Qg,k:Gg,t:Kg,n:Xg,v:Yg,x:Zg,r:bg,e:ty},ey={ques:"Виды тестирования",result:`
...
`},ry={ques:"Fake в unit тестировании",result:`
...
`},ly={ques:"Stub в unit тестировании",result:`
...
`},oy={ques:"Mock в unit тестировании?",result:`
...
`},iy={ques:"White/Black/Grey Box-тестирование?",result:`
...
`},uy={ques:"Что такое Quality Gates",result:`
...
`},sy={ques:"Разница между TDD и BDD",result:`
...
`},ay={ques:"UI-тестирование",result:`
...
`},cy={ques:"Как можно оценить качество тестирования",result:`
...
`},dy={ques:"Принцип FIRST в тестировании",result:`
...
`},fy={v:ey,f:ry,s:ly,m:oy,b:iy,g:uy,t:sy,u:ay,e:cy,i:dy},py={ques:"Метрики в программировании",result:`
...
`},vy={ques:"Что такое БЭМ-сущность?",result:`
...
`},gy={m:py,i:my,e:vy,p:hy},yy={ques:"Что такое vue?",result:"vue - это ..."},Sy={e:yy},Nr={html:Ep,css:Tm,methodology:gy,react:pv,type_script:zv,web:Eh,java_script:Ug,git:Kp,oop:ny,testing:fy,vue:Sy},wy=Object.keys(Nr),Wo={html:"HTML и вёрстка",git:"GIT",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web",vue:"Vue"},ky=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>{const e=r=>{r.target.tagName==="BUTTON"&&(t(r.target.id),n(!1))};return N.jsx("div",{className:Xu.dropDown,children:N.jsx("ul",{className:Xu.dropDown_list,onClick:e,children:wy.map(r=>N.jsx("li",{children:N.jsx(cc,{text:Wo[r],id:r,position:"menu"})},Wo[r]))})})}),Ty=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>N.jsx("div",{className:Ku.menu_nav,children:N.jsx("ul",{className:Ku.menu_nav_list,children:N.jsx(ky,{setWindowContentName:t,setIsActiveMenu:n})})})),Cy="_list_ques_91ie3_1",Py="_window_content__answer_91ie3_5",xy="_window_content_91ie3_5",_y="_window_content__text_91ie3_20",Ey="_title_page_91ie3_30",Ry="_input_search_91ie3_36",Ly="_input_search_input_91ie3_41",My="_not_matches_91ie3_53",$y="_button_back_91ie3_58",At={list_ques:Cy,window_content__answer:Py,window_content:xy,window_content__text:_y,title_page:Ey,input_search:Ry,input_search_input:Ly,not_matches:My,button_back:$y},Ny=(t,n)=>{const e=t.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(n))for(let[i,u]of Object.entries(o))JSON.stringify(u).toLowerCase().indexOf(e)!=-1&&r.push([i,u,l]);return r},Dy=(t,n=300)=>{let e=null;return(...r)=>{window.clearTimeout(e),e=setTimeout(()=>{t(...r)},n)}};function qy({windowContentName:t,setIsActiveMenu:n,setWindowContentName:e}){const[r,l]=vt.useState(null),[o,i]=vt.useState(""),[u,s]=vt.useState(0),d=Dy(y=>{if(y.target){const S=y.target.value.trim().toLowerCase();i(S)}},800),v=()=>{l(null),n(!1),setTimeout(()=>window.scrollTo(0,u),0)},m=vt.useMemo(()=>{const y=w=>{const D=w.target.parentElement.getAttribute("data-name");if(D&&e(D),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?Ny(o,Nr):Object.entries(Nr[t]);return N.jsx(kr.Fragment,{children:S.length>0?N.jsx("ol",{className:At.list_ques,onClick:y,children:S.map((w,D)=>{var c;return N.jsx("li",{"data-name":w[2]?w[2]:"",children:N.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+D)})}):N.jsx("div",{className:At.not_matches,children:"Совпадений не найдено"})})},[t,o]),p=vt.useMemo(()=>{var S;const y=Nr[t];if(r)return N.jsxs("article",{className:At.window_content__answer,children:[N.jsx("h1",{children:(S=y==null?void 0:y[r])==null?void 0:S.ques}),N.jsx("div",{className:At.window_content__text,children:N.jsx("p",{children:y==null?void 0:y[r].result})})]})},[t,r]);return N.jsxs("div",{className:At.window_content,children:[!r&&N.jsxs(kr.Fragment,{children:[N.jsx("div",{className:At.input_search,children:N.jsx("input",{className:At.input_search_input,type:"text",onChange:d,placeholder:"Поиск по содержимому всех тем"})}),N.jsx("h1",{className:At.title_page,children:o?"Результат поиска":Wo[t]})]}),r?N.jsxs(kr.Fragment,{children:[N.jsx("button",{className:At.button_back,onClick:v,children:"BACK"}),p]}):m]})}function Oy(){const[t,n]=vt.useState(""),[e,r]=vt.useState(!0),l=()=>{r(!0),n("")};return N.jsx("main",{children:N.jsxs("div",{className:Gu.wrapper,children:[N.jsx("button",{onClick:l,className:Gu.open_menu,children:"MENU"}),!!t&&N.jsx(qy,{windowContentName:t,setWindowContentName:n,setIsActiveMenu:r}),e&&N.jsx(Ty,{setWindowContentName:n,setIsActiveMenu:r})]})})}Kl.createRoot(document.getElementById("root")).render(N.jsx(kr.StrictMode,{children:N.jsx(Oy,{})}));
