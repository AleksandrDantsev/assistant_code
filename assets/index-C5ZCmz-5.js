...
`}},Qd={i:{ques:"Что такое бэм?",result:`
...
`}},Gd={i:{ques:"Что такое react?",result:`
...
`}},Kd={i:{ques:"Что такое TypeScript",result:`
...
`}},Xd={i:{ques:"Что такое прогрессивный рендеринг",result:`
...
`}},Yd={i:{ques:"Что такое DOM?",result:`
...
`}},Zd={i:{ques:"Основные принципы ООП",result:`
...
`}},bd={v:{ques:"Виды тестирования",result:`
...
`}},Dr={html:Vd,css:$d,methodology:Qd,react:Gd,type_script:Kd,web:Xd,java_script:Yd,oop:Zd,testing:bd},ep=Object.keys(Dr),Bo={html:"HTML и вёрстка",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web"},tp=ve.memo(({setWindowContentName:e,setIsActiveMenu:t})=>{const n=r=>{r.target.tagName==="BUTTON"&&(e(r.target.id),t(!1))};return D.jsx("div",{className:Xi.dropDown,children:D.jsx("ul",{className:Xi.dropDown_list,onClick:n,children:ep.map(r=>D.jsx("li",{children:D.jsx(cc,{text:Bo[r],id:r,position:"menu"})},Bo[r]))})})}),np=ve.memo(({setWindowContentName:e,setIsActiveMenu:t})=>D.jsx("div",{className:Ki.menu_nav,children:D.jsx("ul",{className:Ki.menu_nav_list,children:D.jsx(tp,{setWindowContentName:e,setIsActiveMenu:t})})})),rp="_list_ques_1gyqw_1",lp="_window_content__answer_1gyqw_5",op="_window_content_1gyqw_5",up="_window_content__text_1gyqw_20",ip="_title_page_1gyqw_30",sp="_input_search_1gyqw_36",ap="_input_search_input_1gyqw_41",cp="_not_matches_1gyqw_53",fp="_button_back_1gyqw_58",Fe={list_ques:rp,window_content__answer:lp,window_content:op,window_content__text:up,title_page:ip,input_search:sp,input_search_input:ap,not_matches:cp,button_back:fp},dp=(e,t)=>{const n=e.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(t))for(let[u,i]of Object.entries(o))JSON.stringify(i).toLowerCase().indexOf(n)!=-1&&r.push([u,i,l]);return r},pp=(e,t=300)=>{let n=null;return(...r)=>{window.clearTimeout(n),n=setTimeout(()=>{e(...r)},t)}};function mp({windowContentName:e,setIsActiveMenu:t,setWindowContentName:n}){const[r,l]=ve.useState(null),[o,u]=ve.useState(""),[i,s]=ve.useState(0),f=pp(g=>{if(g.target){const S=g.target.value.trim().toLowerCase();u(S)}},800),v=()=>{l(null),t(!1),setTimeout(()=>window.scrollTo(0,i),0)},m=ve.useMemo(()=>{const g=w=>{const O=w.target.parentElement.getAttribute("data-name");if(O&&n(O),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?dp(o,Dr):Object.entries(Dr[e]);return D.jsx(kr.Fragment,{children:S.length>0?D.jsx("ol",{className:Fe.list_ques,onClick:g,children:S.map((w,O)=>{var c;return D.jsx("li",{"data-name":w[2]?w[2]:"",children:D.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+O)})}):D.jsx("div",{className:Fe.not_matches,children:"Совпадений не найдено"})})},[e,o]),p=ve.useMemo(()=>{var S;const g=Dr[e];if(r)return D.jsxs("article",{className:Fe.window_content__answer,children:[D.jsx("h1",{children:(S=g==null?void 0:g[r])==null?void 0:S.ques}),D.jsx("div",{className:Fe.window_content__text,children:D.jsx("p",{children:g==null?void 0:g[r].result})})]})},[e,r]);return D.jsxs("div",{className:Fe.window_content,children:[!r&&D.jsxs(kr.Fragment,{children:[D.jsx("div",{className:Fe.input_search,children:D.jsx("input",{className:Fe.input_search_input,type:"text",onChange:f,placeholder:"Поиск по содержимому всех тем"})}),D.jsx("h1",{className:Fe.title_page,children:Bo[e]})]}),r?D.jsxs(kr.Fragment,{children:[D.jsx("button",{className:Fe.button_back,onClick:v,children:"BACK"}),p]}):m]})}function vp(){const[e,t]=ve.useState(""),[n,r]=ve.useState(!0),l=()=>{r(!0),t("")};return D.jsx("main",{children:D.jsxs("div",{className:Gi.wrapper,children:[D.jsx("button",{onClick:l,className:Gi.open_menu,children:"MENU"}),!!e&&D.jsx(mp,{windowContentName:e,setWindowContentName:t,setIsActiveMenu:r}),n&&D.jsx(np,{setWindowContentName:t,setIsActiveMenu:r})]})})}Kl.createRoot(document.getElementById("root")).render(D.jsx(kr.StrictMode,{children:D.jsx(vp,{})}));
