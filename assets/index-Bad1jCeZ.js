...
`},Pp={ques:"Для чего используют атрибут inputmode",result:`
...
`},Cp={ques:"Для чего используется атрибут pattern",result:`
...
`},Lp={i:Qf,ns:Gf,sl:Xf,t:Kf,a:Yf,g:Zf,k:bf,d:tp,st:np,v:ep,s:rp,f:lp,l:op,da:ip,dl:up,z:sp,m:ap,w:cp,cv:dp,av:fp,tr:pp,ac:mp,sc:vp,nv:hp,fr:gp,sb:yp,hd:Sp,mp:wp,op:kp,ek:Tp,nl:_p,im:Pp,pt:Cp,pf:xp,sa:Ep,km:Rp},Mp={ques:"Что такое GIT",result:`
...
`},Jp={ques:"Как отменить незакоммиченные изменения git",result:`
...
`},Bp={ques:"Как правильно писать коммиты git",result:`
...
`},Vp={ques:"Как отменить слияние веток git",result:`
...
`},Yp={i:Mp,r:Dp,c:Np,o:$p,a:qp,v:Op,u:Ip,e:zp,d:Hp,s:jp,m:Ap,p:Fp,h:Up,z:Wp,q:Jp,b:Bp,n:Vp,y:Qp,l:Gp,x:Xp,f:Kp},Zp={ques:"Что такое css?",result:`
...
`},Pm={ques:"Краткая форма записи свойств?",result:`
...
`},Cm={ques:"Контейнерные запросы",result:`
...
`},Em={i:Zp,p:bp,mn:tm,e:nm,a:em,b:rm,s:lm,sa:om,r:im,k:um,u:sm,v:am,f:cm,c:dm,pr:fm,q:pm,sp:mm,g:vm,cc:hm,fl:gm,fn:ym,z:Sm,an:wm,tr:km,td:Tm,sg:_m,br:Pm,ct:Cm,m:xm},Rm={ques:"Что такое React?",result:`
	...
	организованным.
`},Lm={ques:"Особенности React",result:`
...
`},Mm={ques:"Что такое серверный рендеринг (Server-Side Rendering)",result:`
...
`},Jm={ques:"Что такое React Fiber",result:`
...
`},Bm={ques:"Синтетические события в react",result:`
...
`},Vm={ques:"Что такое компонент-переключатель (Switching Component)",result:`
...
`},i:Rm,h:Lm,sr:Mm,pr:Dm,li:Nm,ah:$m,tt:qm,r:Om,k:Im,p:zm,c:Hm,q:jm,t:Am,b:Fm,j:Um,s:Wm,f:Jm,y:Bm,m:Vm,d:Qm,z:Gm,n:Xm,u:Km,e:Ym,a:Zm,ma:bm,de:tv,w:nv,hp:ev,bb:rv,pa:lv,l:ov,su:iv,fi:uv,uu:sv,o:av,sf:cv,rx:dv,rc:fv,ss:pv,mw:mv,rd:vv,st:hv,rp:gv,nb:yv},wv={ques:"Что такое TypeScript",result:`
...
`},Cv={ques:"Что такое перегрузка функций",result:`
...
`},Lv={ques:" Что такое внешние объявления переменных (ambient declaration) ",result:`
...
`},Mv={ques:"Абстрактный класс в TypeScript",result:`
...
`},i:wv,s:kv,p:Tv,t:_v,d:Pv,f:Cv,r:xv,o:Ev,k:Rv,w:Lv,a:Mv,q:Dv,m:Nv,e:$v,n:qv,ni:Ov,v:Iv,g:zv,l:Hv,x:jv,j:Av,y:Fv,u:Uv},Jv={ques:"Опишите весь процесс, начиная с ввода адреса сайта в адресную строку до окончания его загрузки на экране",result:`
...
`},Bv={ques:"Отличие компилятора от интерпретатора",result:`
	...
	требуют компиляции.
`},Vv={ques:"Что такое прогрессивный рендеринг",result:`
...
`},Ph={ques:"Что такое WebSocket",result:`
...
`},Ch={ques:"Разница между Long-Polling, Websockets и Server-Sent Events",result:`
...
`},Lh={ques:"Что такое Web Worklet",result:`
...
`},Mh={ques:"Механизм установки сеанса между клиентом и сервером",result:`
...
`},lk:Jv,ki:Bv,i:Vv,p:Qv,z:Gv,c:Xv,pt:Kv,o:Yv,d:Zv,m:bv,g:th,w:nh,r:eh,f:rh,a:lh,l:oh,jf:ih,u:uh,h:sh,cm:ah,v:ch,k:dh,s:fh,x:ph,j:mh,e:vh,t:hh,b:gh,n:yh,t2:Sh,w2:wh,ts:kh,pu:Th,d2:_h,ws:Ph,dt:Ch,jp:xh,in:{ques:"Что такое IndexedDB в браузере? Преимущества IndexedDB",result:`
...
`},sw:Eh,ww:Rh,w5:Lh,dd:Mh,ap:Dh,cd:Nh,ip:$h,hd:qh,ur:Oh,qq:Ih,sv:zh,dw:Hh,bv:jh,gg:Ah,ew:Fh,wq:Uh,bb:Wh},Bh={ques:"Что такое DOM?",result:`
...
`},Pg={ques:"Разница между глубокой (deep) и поверхностной (shallow) копиями",result:`
	...
	Для создания глубокой копии объекта:
		...
		-Рекурсивно
		-Библиотеки
`},Cg={ques:"Цепочка вызовов функций (chaining)",result:`
...
`},Lg={ques:"Как работает метод Object.create()",result:`
...
`},Mg={ques:"Object.freeze() и Object.seal()",result:`
...
`},Vg={ques:"Что такое same-origin policy в контексте JavaScript",result:`
...
`},i:Bh,n:Vh,m:Qh,c:Gh,b:Xh,e:Kh,s:Yh,t:Zh,l:bh,q:tg,x:ng,h:eg,o:rg,u:lg,td:og,st:ig,f:ug,ti:sg,p:ag,sc:cg,z:dg,th:fg,mn:pg,fc:mg,pm:vg,hn:hg,pe:gg,pl:yg,na:Sg,w:wg,ar:kg,bu:Tg,ih:_g,ds:Pg,ch:Cg,uv:xg,af:Eg,po:Rg,oc:Lg,fs:Mg,ms:Dg,im:Ng,to:$g,er:qg,tt:Og,sd:Ig,re:zg,pf:Hg,es:jg,lm:Ag,ob:Fg,no:Ug,pr:Wg,as:Jg,aj:Bg,sp:Vg,ma:Qg,ps:Gg,yt:Xg,da:Kg,ac:Yg,pp:Zg,cf:bg,aa:ty,p0:ny,g:ey,k:ry,q1:ly,wm:oy,tz:iy},sy={ques:"Основные принципы ООП",result:`
...
`},Cy={ques:"White/Black/Grey Box-тестирование?",result:`
...
`},Ly={ques:"Как можно оценить качество тестирования",result:`
...
`},My={ques:"Принцип FIRST в тестировании",result:`
...
`},Dy={v:ky,f:Ty,s:_y,m:Py,b:Cy,g:xy,t:Ey,u:Ry,e:Ly,i:My},Ny={ques:"Метрики в программировании",result:`
...
`},Iy={m:Ny,i:$y,e:qy,p:Oy},zy={ques:"Что такое vue?",result:"vue - это ..."},Hy={e:zy},Nr={html:Lp,css:Em,methodology:Iy,react:Sv,type_script:Wv,web:Jh,java_script:uy,git:Yp,oop:wy,testing:Dy,vue:Hy},jy=Object.keys(Nr),Wo={html:"HTML и вёрстка",git:"GIT",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web",vue:"Vue"},Ay=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>{const e=r=>{r.target.tagName==="BUTTON"&&(t(r.target.id),n(!1))};return N.jsx("div",{className:Ku.dropDown,children:N.jsx("ul",{className:Ku.dropDown_list,onClick:e,children:jy.map(r=>N.jsx("li",{children:N.jsx(cc,{text:Wo[r],id:r,position:"menu"})},Wo[r]))})})}),Fy=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>N.jsx("div",{className:Xu.menu_nav,children:N.jsx("ul",{className:Xu.menu_nav_list,children:N.jsx(Ay,{setWindowContentName:t,setIsActiveMenu:n})})})),Uy="_list_ques_91ie3_1",Wy="_window_content__answer_91ie3_5",Jy="_window_content_91ie3_5",By="_window_content__text_91ie3_20",Vy="_title_page_91ie3_30",Qy="_input_search_91ie3_36",Gy="_input_search_input_91ie3_41",Xy="_not_matches_91ie3_53",Ky="_button_back_91ie3_58",At={list_ques:Uy,window_content__answer:Wy,window_content:Jy,window_content__text:By,title_page:Vy,input_search:Qy,input_search_input:Gy,not_matches:Xy,button_back:Ky},Yy=(t,n)=>{const e=t.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(n))for(let[i,u]of Object.entries(o))JSON.stringify(u).toLowerCase().indexOf(e)!=-1&&r.push([i,u,l]);return r},Zy=(t,n=300)=>{let e=null;return(...r)=>{window.clearTimeout(e),e=setTimeout(()=>{t(...r)},n)}};function by({windowContentName:t,setIsActiveMenu:n,setWindowContentName:e}){const[r,l]=vt.useState(null),[o,i]=vt.useState(""),[u,s]=vt.useState(0),d=Zy(y=>{if(y.target){const S=y.target.value.trim().toLowerCase();i(S)}},800),v=()=>{l(null),n(!1),setTimeout(()=>window.scrollTo(0,u),0)},m=vt.useMemo(()=>{const y=w=>{const $=w.target.parentElement.getAttribute("data-name");if($&&e($),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?Yy(o,Nr):Object.entries(Nr[t]);return N.jsx(kr.Fragment,{children:S.length>0?N.jsx("ol",{className:At.list_ques,onClick:y,children:S.map((w,$)=>{var c;return N.jsx("li",{"data-name":w[2]?w[2]:"",children:N.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+$)})}):N.jsx("div",{className:At.not_matches,children:"Совпадений не найдено"})})},[t,o]),p=vt.useMemo(()=>{var S;const y=Nr[t];if(r)return N.jsxs("article",{className:At.window_content__answer,children:[N.jsx("h1",{children:(S=y==null?void 0:y[r])==null?void 0:S.ques}),N.jsx("div",{className:At.window_content__text,children:N.jsx("p",{children:y==null?void 0:y[r].result})})]})},[t,r]);return N.jsxs("div",{className:At.window_content,children:[!r&&N.jsxs(kr.Fragment,{children:[N.jsx("div",{className:At.input_search,children:N.jsx("input",{className:At.input_search_input,type:"text",onChange:d,placeholder:"Поиск по содержимому всех тем"})}),N.jsx("h1",{className:At.title_page,children:o?"Результат поиска":Wo[t]})]}),r?N.jsxs(kr.Fragment,{children:[N.jsx("button",{className:At.button_back,onClick:v,children:"BACK"}),p]}):m]})}function t1(){const[t,n]=vt.useState(""),[e,r]=vt.useState(!0),l=()=>{r(!0),n("")};return N.jsx("main",{children:N.jsxs("div",{className:Gu.wrapper,children:[N.jsx("button",{onClick:l,className:Gu.open_menu,children:"MENU"}),!!t&&N.jsx(by,{windowContentName:t,setWindowContentName:n,setIsActiveMenu:r}),e&&N.jsx(Fy,{setWindowContentName:n,setIsActiveMenu:r})]})})}Xl.createRoot(document.getElementById("root")).render(N.jsx(kr.StrictMode,{children:N.jsx(t1,{})}));
