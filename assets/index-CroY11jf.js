...
`},Ip={ques:"Разница между Normalize.css и Reset CSS??",result:`
	...
	старых браузеров
`},qp={ques:"Разница между классом и идентификатором?",result:`
...
`},tm={i:Lp,p:Rp,e:Np,a:Mp,b:$p,s:Dp,sa:Op,r:Ip,k:qp,u:zp,v:jp,f:Hp,c:Ap,pr:Fp,q:Up,sp:Wp,g:Bp,cc:Jp,fl:Vp,z:Qp,tr:Kp,td:Gp,sg:Xp,br:Yp,ct:Zp,m:bp},nm={ques:"Что такое react?",result:`
...
`},qm={ques:"Как выглядит поток данных в Redux-приложении",result:`
...
`},zm={2:{ques:"Разница между рендерингом и монтированием",result:`
...
`},i:nm,h:em,r:rm,k:lm,p:om,c:um,q:im,t:sm,b:am,j:cm,s:fm,f:dm,y:pm,m:mm,d:vm,z:hm,n:ym,u:gm,e:Sm,po:wm,a:km,de:Tm,w:Cm,hp:_m,l:Pm,su:xm,fi:Em,uu:Lm,o:Rm,sf:Nm,rx:Mm,rc:$m,ss:Dm,rd:Om,st:Im,rp:qm},jm={ques:"Что такое TypeScript",result:`
...
`},qv={ques:"Разница между протоколами TCP и UDP",result:`
...
`},zv={ques:"Что такое WebSocket",result:`
...
`},i:sv,p:av,z:cv,c:fv,o:dv,d:pv,m:mv,g:vv,w:hv,r:yv,f:gv,a:Sv,l:wv,u:kv,h:Tv,v:Cv,k:_v,s:Pv,x:xv,j:Ev,e:Lv,t:Rv,b:Nv,n:Mv,t2:$v,w2:Dv,ts:Ov,pu:Iv,d2:qv,ws:zv,dt:jv,jp:Hv,in:{ques:"Что такое IndexedDB в браузере? Преимущества IndexedDB",result:`
...
`},qh={ques:"Плюсы и минусы использования use strict",result:`
	Плюсы:
...
`},zh={ques:"Плюсы и минусы иммутабельности",result:`
	Плюсы:
