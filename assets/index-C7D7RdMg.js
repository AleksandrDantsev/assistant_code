...
`},zh={ques:"feature detection, feature inference и user-agent",result:`
...
`},Hh={0:{ques:"Что такое HTTP cookie? Для чего они используются",result:`
...
`},sw:_h,ww:Ph,w5:Ch,dd:xh,ap:Eh,cd:Rh,ip:Lh,hd:Mh,ur:Nh,qq:Dh,sv:$h,dw:qh,bv:Oh,gg:Ih,ew:zh},jh={ques:"Что такое DOM?",result:`
...
`},Fh={ques:"Методы JavaScript для поиска элементов на странице",result:`
	1.querySelector
	2.querySelectorAll
	3.getElementById
	...
	6.getElementsByName  
`},Uh={ques:"Свойства для перемещения по dom-дереву",result:`
...
`},Jh={ques:"Виды событий Event?",result:`
...
`},Bh={ques:"media выражения в JavaScript",result:`
...
`},Vh={ques:"event.target и event.currentTarget",result:`
...
`},Qh={ques:"события load и DOMContentLoaded",result:`
...
`},Gh={ques:"Метод EventTarget.addEventListener()",result:`
...
`},Xh={ques:"Как узнать об использовании метода event.preventDefault()?",result:`
...
`},Yh={ques:"Intersection Observer",result:`
...
`},ng={ques:"Разница между function declaration и function expression",result:`
...
`},eg={ques:"Типы таймеров в JavaScript",result:`
...
`},rg={ques:"Поднятие (Hoisting)",result:`
...
`},lg={ques:"Область видимости (Scope)",result:`
...
`},ug={ques:"Что такое чистая функция",result:`
...
`},sg={ques:"Почему в JS функции называют объектами первого класса",result:`
...
`},ag={ques:"Псевдомассив arguments",result:`
...
`},cg={ques:"Разница между host-объектами и нативными объектами",result:`
	...
	в любом окружении.
`},dg={ques:"События указателя (Pointer Events)",result:`
...
`},fg={ques:"Прототипное наследование",result:`
...
`},mg={ques:"Объектная обертка (Wrapper Objects)",result:`
...
`},vg={ques:"Проверить, является ли значение массивом",result:`
	Array.isArray(yourVariable)
	val.constructor === Array
	Object.prototype.toString.call(val) === '[object Array]'
`},hg={ques:"boxing/unboxing",result:`
...
`},gg={ques:"Разница между оператором in и методом .hasOwnProperty()",result:`
...
`},yg={ques:"Разница между глубокой (deep) и поверхностной (shallow) копиями",result:`
	...
	Для создания глубокой копии объекта:
		...
		-Рекурсивно
		-Библиотеки
`},Sg={ques:"Цепочка вызовов функций (chaining)",result:`
...
`},wg={ques:"Что такое необъявленная переменная",result:`
...
`},kg={ques:"Как передаются параметры в функцию: по ссылке или по значению",result:`
...
`},Tg={ques:"Что такое прототип объекта в JavaScript",result:`
...
`},_g={ques:"Как работает метод Object.create()",result:`
...
`},Pg={ques:"Object.freeze() и Object.seal()",result:`
...
`},Cg={ques:"Плюсы и минусы использования use strict",result:`
	Плюсы:
...
`},xg={ques:"Плюсы и минусы иммутабельности",result:`
	Плюсы:
...
`},Eg={ques:"Типы ОБЪЕКТОВ JavaScript",result:`
	-Строковые объекты.
	-Числовые объекты
	-Логические объекты
	-Объектные литералы
	-Массивы 
`},Rg={ques:"Типы ошибок в JavaScript",result:`
...
`},Lg={ques:"Разница между typeof и instanceof?",result:`
...
`},Mg={ques:"JavaScript статически, или динамически типизированный язык",result:`
...
`},Ng={ques:"Регулярное выражение (Regular Expression)",result:`
...
`},Dg={ques:"Что такое полифил (polyfill)",result:`
...
`},$g={ques:"expression и statement",result:`
...
`},qg={ques:"Типы утечек памяти в JavaScript",result:`
...
`},Og={ques:"Разница между примитивом и объектом",result:`
...
`},Ig={ques:"Почему typeof null возвращает object",result:`
...
`},zg={ques:"Зачем нужен конструктор Proxy?",result:`
...
`},Hg={ques:"Разница между синхронными и асинхронными функциями",result:`
...
`},Ag={ques:"Что такое same-origin policy в контексте JavaScript",result:`
...
`},Fg={ques:"Разница между микро и макрозадачами в event loop",result:`
...
`},Ug={ques:"Что такое промисы (Promises)",result:`
...
`},Wg={ques:"В каких состояниях может пребывать Promise)",result:`
...
`},Jg={ques:"Плюсы и минусы использовании Ajax",result:`
	Плюсы:
...
`},Bg={ques:"Подходы при работе с асинхронным кодом",result:`
...
`},Vg={ques:"Преимущества использовании промисов вместо колбэков",result:`
...
`},Qg={ques:"Что такое callback-функция? Что такое Callback Hell",result:`
...
`},Gg={ques:"Что такое async/await",result:`
...
`},Kg={ques:"Плюсы и минусы асинхронного программирования",result:`
	Плюсы:
...
`},Xg={ques:"Что такое генераторы? Когда стоит использовать генераторы",result:`
...
`},Yg={ques:"Что такое дескрипторы свойств объектов",result:`
...
`},Zg={ques:" В чем заключаются особенности геттеров и сеттеров",result:`
...
`},bg={ques:"WeakMap и WeakSet",result:`
...
`},ty={ques:"Что такое temporal dead zone",result:`
...
`},ny={0:{ques:"Разница между null и undefined",result:`
...
`},i:jh,n:Ah,m:Fh,c:Uh,b:Wh,e:Jh,s:Bh,t:Vh,l:Qh,q:Gh,x:Kh,h:Xh,o:Yh,u:Zh,td:bh,st:tg,f:ng,ti:eg,p:rg,sc:lg,z:og,th:ig,mn:ug,fc:sg,pm:ag,hn:cg,pe:dg,pl:fg,na:pg,w:mg,ar:vg,bu:hg,ih:gg,ds:yg,ch:Sg,uv:wg,af:kg,po:Tg,oc:_g,fs:Pg,ms:Cg,im:xg,to:Eg,er:Rg,tt:Lg,sd:Mg,re:Ng,pf:Dg,es:$g,lm:qg,ob:Og,no:Ig,pr:zg,as:Hg,aj:jg,sp:Ag,ma:Fg,ps:Ug,yt:Wg,da:Jg,ac:Bg,pp:Vg,cf:Qg,aa:Gg,p0:Kg,g:Xg,k:Yg,q1:Zg,wm:bg,tz:ty},ey={ques:"Основные принципы ООП",result:`
...
`},ry={ques:"Что такое SOLID",result:`
...
`},ly={ques:"Разница между классовым и прототипным наследованием",result:`
...
`},oy={ques:"Однонаправленный поток данных и двусторонняя связь данных",result:`
...
`},uy={ques:"Что такое каррирование (Currying)",result:`
...
`},sy={ques:"Статический метод класса (static)",result:`
...
`},ay={ques:"Типы паттернов в ООП",result:`
...
`},cy={ques:"Как работает механизм прототипов в JavaScript",result:`
...
`},dy={ques:"Разница между императивным и декларативным подходами программирования",result:`
...
`},fy={ques:"Что такое реактивное программирование",result:`
...
`},py={ques:"Разница между агрегацией и композицией",result:`
...
`},my={i:ey,s:ry,p:ly,d:oy,m:iy,k:uy,t:sy,n:ay,v:cy,x:dy,r:fy,e:py},vy={ques:"Виды тестирования",result:`
...
`},hy={ques:"Fake в unit тестировании",result:`
...
`},gy={ques:"Stub в unit тестировании",result:`
...
`},yy={ques:"Mock в unit тестировании?",result:`
...
`},Sy={ques:"White/Black/Grey Box-тестирование?",result:`
...
`},wy={ques:"Что такое Quality Gates",result:`
...
`},ky={ques:"Разница между TDD и BDD",result:`
...
`},Ty={ques:"UI-тестирование",result:`
...
`},_y={ques:"Как можно оценить качество тестирования",result:`
...
`},Py={ques:"Принцип FIRST в тестировании",result:`
...
`},Cy={v:vy,f:hy,s:gy,m:yy,b:Sy,g:wy,t:ky,u:Ty,e:_y,i:Py},xy={ques:"Метрики в программировании",result:`
...
`},Ry={ques:"Что такое БЭМ-сущность?",result:`
...
`},My={m:xy,i:Ey,e:Ry,p:Ly},Ny={ques:"Что такое vue?",result:"vue - это ..."},Dy={e:Ny},Dr={html:Rp,css:_m,methodology:My,react:vv,type_script:jv,web:Hh,java_script:ny,git:Xp,oop:my,testing:Cy,vue:Dy},$y=Object.keys(Dr),Wo={html:"HTML и вёрстка",git:"GIT",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web",vue:"Vue"},qy=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>{const e=r=>{r.target.tagName==="BUTTON"&&(t(r.target.id),n(!1))};return D.jsx("div",{className:Xu.dropDown,children:D.jsx("ul",{className:Xu.dropDown_list,onClick:e,children:$y.map(r=>D.jsx("li",{children:D.jsx(cc,{text:Wo[r],id:r,position:"menu"})},Wo[r]))})})}),Oy=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>D.jsx("div",{className:Ku.menu_nav,children:D.jsx("ul",{className:Ku.menu_nav_list,children:D.jsx(qy,{setWindowContentName:t,setIsActiveMenu:n})})})),Iy="_list_ques_91ie3_1",zy="_window_content__answer_91ie3_5",Hy="_window_content_91ie3_5",jy="_window_content__text_91ie3_20",Ay="_title_page_91ie3_30",Fy="_input_search_91ie3_36",Uy="_input_search_input_91ie3_41",Wy="_not_matches_91ie3_53",Jy="_button_back_91ie3_58",At={list_ques:Iy,window_content__answer:zy,window_content:Hy,window_content__text:jy,title_page:Ay,input_search:Fy,input_search_input:Uy,not_matches:Wy,button_back:Jy},By=(t,n)=>{const e=t.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(n))for(let[i,u]of Object.entries(o))JSON.stringify(u).toLowerCase().indexOf(e)!=-1&&r.push([i,u,l]);return r},Vy=(t,n=300)=>{let e=null;return(...r)=>{window.clearTimeout(e),e=setTimeout(()=>{t(...r)},n)}};function Qy({windowContentName:t,setIsActiveMenu:n,setWindowContentName:e}){const[r,l]=vt.useState(null),[o,i]=vt.useState(""),[u,s]=vt.useState(0),d=Vy(y=>{if(y.target){const S=y.target.value.trim().toLowerCase();i(S)}},800),v=()=>{l(null),n(!1),setTimeout(()=>window.scrollTo(0,u),0)},m=vt.useMemo(()=>{const y=w=>{const $=w.target.parentElement.getAttribute("data-name");if($&&e($),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?By(o,Dr):Object.entries(Dr[t]);return D.jsx(kr.Fragment,{children:S.length>0?D.jsx("ol",{className:At.list_ques,onClick:y,children:S.map((w,$)=>{var c;return D.jsx("li",{"data-name":w[2]?w[2]:"",children:D.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+$)})}):D.jsx("div",{className:At.not_matches,children:"Совпадений не найдено"})})},[t,o]),p=vt.useMemo(()=>{var S;const y=Dr[t];if(r)return D.jsxs("article",{className:At.window_content__answer,children:[D.jsx("h1",{children:(S=y==null?void 0:y[r])==null?void 0:S.ques}),D.jsx("div",{className:At.window_content__text,children:D.jsx("p",{children:y==null?void 0:y[r].result})})]})},[t,r]);return D.jsxs("div",{className:At.window_content,children:[!r&&D.jsxs(kr.Fragment,{children:[D.jsx("div",{className:At.input_search,children:D.jsx("input",{className:At.input_search_input,type:"text",onChange:d,placeholder:"Поиск по содержимому всех тем"})}),D.jsx("h1",{className:At.title_page,children:o?"Результат поиска":Wo[t]})]}),r?D.jsxs(kr.Fragment,{children:[D.jsx("button",{className:At.button_back,onClick:v,children:"BACK"}),p]}):m]})}function Gy(){const[t,n]=vt.useState(""),[e,r]=vt.useState(!0),l=()=>{r(!0),n("")};return D.jsx("main",{children:D.jsxs("div",{className:Gu.wrapper,children:[D.jsx("button",{onClick:l,className:Gu.open_menu,children:"MENU"}),!!t&&D.jsx(Qy,{windowContentName:t,setWindowContentName:n,setIsActiveMenu:r}),e&&D.jsx(Oy,{setWindowContentName:n,setIsActiveMenu:r})]})})}Kl.createRoot(document.getElementById("root")).render(D.jsx(kr.StrictMode,{children:D.jsx(Gy,{})}));
