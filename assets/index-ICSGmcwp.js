 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Rc=vt,Lc=Symbol.for("react.element"),Mc=Symbol.for("react.fragment"),Nc=Object.prototype.hasOwnProperty,Dc=Rc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,$c={key:!0,ref:!0,__self:!0,__source:!0};function is(t,n,e){var r,l={},o=null,i=null;e!==void 0&&(o=""+e),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(i=n.ref);for(r in n)Nc.call(n,r)&&!$c.hasOwnProperty(r)&&(l[r]=n[r]);if(t&&t.defaultProps)for(r in n=t.defaultProps,n)l[r]===void 0&&(l[r]=n[r]);return{$$typeof:Lc,type:t,key:o,ref:i,props:l,_owner:Dc.current}}rl.Fragment=Mc;rl.jsx=is;rl.jsxs=is;Yu.exports=rl;var D=Yu.exports,Kl={},us={exports:{}},St={},ss={exports:{}},as={};/**
 * @license React
...
`},Gf={ques:"Что такое HTML-элемент? Какова его структура?",result:`
...
`},Xf={ques:"Что такое атрибуты в HTML",result:`
...
`},Yf={ques:"Глобальные атрибуты есть в HTML",result:`
...
`},Zf={ques:"Что такое категории контента в HTML5",result:`
...
`},bf={ques:"Что такое doctype? И для чего он используется",result:`
...
`},dp={ques:"Свойство valueAsNumber",result:`
...
`},fp={ques:"Что такое атрибут target",result:`
...
`},_p={ques:"Для чего используют атрибут inputmode",result:`
...
`},Cp={ques:"Способы улучшения производительности веб-страницы при использовании HTML",result:`
...
`},Ep={ques:"Что такое карта-изображение",result:`
...
`},Rp={i:Qf,sl:Gf,t:Kf,a:Xf,g:Yf,k:Zf,d:bf,st:tp,v:np,s:ep,f:rp,l:lp,da:op,dl:ip,z:up,m:sp,w:ap,cv:cp,av:dp,tr:fp,ac:pp,sc:mp,nv:vp,fr:hp,sb:gp,hd:yp,mp:Sp,op:wp,ek:kp,nl:Tp,im:_p,pt:Pp,pf:Cp,sa:xp,km:Ep},Lp={ques:"Что такое GIT",result:`
...
`},Mp={ques:"Команда git reset --hard",result:`
...
`},Dp={ques:"Как объединить несколько коммитов в один",result:`
...
`},qp={ques:"Почему некоторые флаги идут с одним дефисом, а некоторые с двумя ",result:`
	...
	от пути к файлу.
`},Op={ques:"Что такое upstream в git",result:`
...
`},Ip={ques:"Как удалить из индекса git",result:`
...
`},zp={ques:"Как переименовать ветку в git",result:`
...
`},Ap={ques:"Как обновить удаленный репозиторий git",result:`
...
`},Fp={ques:" Как отменить git init",result:`
	...
	если она у вас есть.
`},Up={ques:"Как переключиться на другую ветку git",result:`
...
`},Wp={ques:"Как отменить незакоммиченные изменения git",result:`
...
`},Vp={ques:"Как посмотреть все ветки git в репозитории",result:`
...
`},Qp={ques:"Как сделать коммит в другую ветку git",result:`
...
`},Gp={ques:"Как откатить коммит git в удаленном репозитории",result:`
...
`},Xp={i:Lp,r:Mp,c:Np,o:Dp,a:$p,v:qp,u:Op,e:Ip,d:zp,s:Hp,m:jp,p:Ap,h:Fp,z:Up,q:Wp,b:Jp,n:Bp,y:Vp,l:Qp,x:Gp,f:Kp},Yp={ques:"Что такое css?",result:`
...
`},Zp={ques:"Приоритеты селекторов",result:`
	По убыванию:
	1.Important
	2.Инлайн стили
	3.ID
	4.Селектор классов
	5.Cелектор тегов
`},bp={ques:"Способы добавить CSS на страницу",result:`
...
`},tm={ques:"Позиционирование",result:`
...
`},nm={ques:"Блочная модель css",result:`
	...
	3.margin 
	4.border
`},em={ques:"Cелектор и какие селекторы существуют",result:`
...
`},rm={ques:"Что такое специфичность селектора?",result:`
...
`},lm={ques:"Разница между Normalize.css и Reset CSS??",result:`
	...
	старых браузеров
`},om={ques:"Разница между классом и идентификатором?",result:`
...
`},um={ques:"Вендорный префикс?",result:`
...
`},sm={ques:"Что такое псевдоэлементы?",result:`
	...
	::spelling-error
	::grammar-error 
`},am={ques:"Схлопывание внешних отступов?",result:`
...
`},cm={ques:"css препроцессоры",result:`
	...
	Sass (SCSS)
	Stylus
`},dm={ques:"Контекст наложения",result:`
...
`},pm={ques:"Глобальные ключевые слова в CSS?",result:`
...
`},mm={ques:"currentColor в CSS?",result:`
...
`},vm={ques:"Свойство display в CSS?",result:`
	...
	list-item, run-in
`},hm={ques:"Свойство float в CSS?",result:`
...
`},gm={ques:"Свойство text-rendering?",result:`
...
`},km={ques:"Контейнерные запросы",result:`
...
`},Tm={ques:"prefers-reduced-motion?",result:`
...
`},_m={i:Yp,p:Zp,e:bp,a:tm,b:nm,s:em,sa:rm,r:lm,k:om,u:im,v:um,f:sm,c:am,pr:cm,q:dm,sp:fm,g:pm,cc:mm,fl:vm,z:hm,tr:gm,td:ym,sg:Sm,br:wm,ct:km,m:Tm},Pm={ques:"Что такое React?",result:`
	...
	организованным.
`},Cm={ques:"Особенности React",result:`
...
`},xm={ques:"Что такое серверный рендеринг (Server-Side Rendering)",result:`
...
`},Em={ques:"Перечислите преимущества серверного рендеринга",result:`
	...
	стороне сервера.
`},Rm={ques:"Что такое линтеры",result:`
	...
	для CSS и Sass.
`},Lm={ques:"Какие архитектурные решения для React вы знаете",result:`
...
`},Mm={ques:"Как выполняется валидация данных в React-приложении",result:`
...
`},Nm={ques:"Что такое Virtual DOM",result:`
...
`},Dm={ques:"Атрибут key при рендере?",result:`
...
`},qm={ques:"Higher-Order Component / HOC",result:`
...
`},Om={ques:"Жизненный цикл компонентов React",result:`
	1.Инициализация
	2.Монтирование
	3.Обновление
	4.Размонтирование
`},Im={ques:"Что такое Portal",result:`
...
`},zm={ques:"Что такое React хуки",result:`
...
`},jm={ques:"Разница между состоянием(state) и пропсами(props)?",result:`
...
`},Am={ques:"Что такое React Fiber",result:`
...
`},Fm={ques:"Синтетические события в react",result:`
...
`},Um={ques:"Что такое компонент-переключатель (Switching Component)",result:`
...
`},Wm={ques:"Что такое React DOM",result:`
...
`},Jm={ques:"Разница между компонентом и контейнером React",result:`
...
`},Bm={ques:"Что такое «опрос» (Polling)",result:`
...
`},Qm={ques:"Что такое предохранители (Error Boundaries)",result:`
...
`},Gm={ques:"Инверсия наследования (Inheritance Inversion)",result:`
...
`},Km={ques:"Чем управляемые компоненты отличаются от неуправляемых",result:`
...
`},Xm={ques:"Разница между классовым и функциональным компонентами",result:`
...
`},Ym={ques:" Разница между useEffect() и componentDidMount()",result:`
...
`},Zm={ques:"Преимущества хуков",result:`
...
`},bm={ques:"Что такое методы жизненного цикла компонента",result:`
...
`},tv={ques:"Что такое публичный API",result:`
...
`},nv={ques:"Lifting State Up",result:`
...
`},ev={ques:"Что делает метод shouldComponentUpdate",result:`
	...
	приложения.
`},rv={ques:"Как реализовать однократное выполнение операции при начальном рендеринге?",result:`
...
`},lv={ques:"useImperativeHandle(), useLayoutEffect()",result:`
...
`},ov={ques:"Что такое реактивность",result:`
...
`},iv={ques:"Лучшие практики безопасности в React",result:`
...
`},uv={ques:"Что такое Redux? Ключевые принципы Redux",result:`
...
`},sv={ques:"Ключевые концепции Redux",result:`
...
`},av={ques:"Что такое «единственный источник истины» (Single Source of Truth)",result:`
...
`},cv={ques:"Middleware Redux",result:`
...
`},dv={ques:"Что такое редьюсер (Reducer)",result:`
...
`},fv={ques:"Разница между React State и Redux State",result:`
...
`},pv={ques:"Как выглядит поток данных в Redux-приложении",result:`
...
`},mv={ques:"Почему для архитектуры React+Redux важна иммутабельность",result:`
...
`},vv={2:{ques:"Разница между рендерингом и монтированием",result:`
...
`},i:Pm,h:Cm,sr:xm,pr:Em,li:Rm,ah:Lm,tt:Mm,r:Nm,k:Dm,p:$m,c:qm,q:Om,t:Im,b:zm,j:Hm,s:jm,f:Am,y:Fm,m:Um,d:Wm,z:Jm,n:Bm,u:Vm,e:Qm,a:Gm,ma:Km,de:Xm,w:Ym,hp:Zm,bb:bm,pa:tv,l:nv,su:ev,fi:rv,uu:lv,o:ov,sf:iv,rx:uv,rc:sv,ss:av,mw:cv,rd:dv,st:fv,rp:pv,nb:mv},hv={ques:"Что такое TypeScript",result:`
	...
	JavaScript.
`},gv={ques:"Назовите особенности TypeScript",result:`
...
`},yv={ques:"Плюсы использования TypeScript?",result:`
	-Более строгий контроль типов.
	-Более читаемый код.
	-Совместимость с JavaScript.
	-Поддерживается многими инструментами.
	-Может улучшить производительность.
`},Sv={ques:"Типы в TypeScript?",result:`
...
`},kv={ques:"Что такое перегрузка функций",result:`
	...
	типа аргумента.
`},Tv={ques:"Поддерживает ли TypeScript перегрузку функций",result:`
...
`},_v={ques:"Разница между type и  interface в typescript",result:`
...
`},Pv={ques:"Что такое директивы с тремя наклонными чертами (Triple-Slash Directives), их типы",result:`
...
`},Cv={ques:" Что такое внешние объявления переменных (ambient declaration) ",result:`
...
`},xv={ques:"Абстрактный класс в TypeScript",result:`
...
`},Ev={ques:" Какие элементы ООП поддерживаются в TypeScript",result:`
...
`},Rv={ques:"Модификаторы доступа в TypeScript",result:`
...
`},Lv={ques:"Internal Module и External Module",result:`
	...
	различных проектах.
`},Mv={ques:"Перечисление (enum)",result:`
...
`},Dv={ques:"“Объединение” (|) и “Пересечение” (&) typescript",result:`
...
`},qv={ques:"Какие области видимости доступны в TypeScript",result:`
...
`},Ov={ques:"Что такое .map файл, как и зачем его использовать",result:`
...
`},Iv={ques:"Можно ли использовать TypeScript в серверной разработке",result:`
...
`},zv={ques:"Ключевое слово declare",result:`
	...
	или заполнены позже.
`},Hv={ques:"Как вы отлавливаете ошибки в TypeScript коде",result:`
...
`},jv={4:{ques:"Разница между типами void, never и unknown",result:`
...
`},i:hv,s:gv,p:yv,t:Sv,d:wv,f:kv,r:Tv,o:_v,k:Pv,w:Cv,a:xv,q:Ev,m:Rv,e:Lv,n:Mv,ni:Nv,v:Dv,g:$v,l:qv,x:Ov,j:Iv,y:zv,u:Hv},Av={ques:"Опишите весь процесс, начиная с ввода адреса сайта в адресную строку до окончания его загрузки на экране",result:`
...
`},Fv={ques:"Отличие компилятора от интерпретатора",result:`
	...
	требуют компиляции.
`},Uv={ques:"Что такое прогрессивный рендеринг",result:`
...
`},Wv={ques:"Progressive Web Application (PWA)",result:`
...
`},Jv={ques:"Что происходит при введение запроса в строку",result:`
...
`},Bv={ques:"Кроссбраузерность",result:`
...
`},Vv={ques:"Чем отличаются PUT- и POST-запросы",result:`
...
`},Gv={ques:"Поток документа",result:`
...
`},Kv={ques:"Разница между адаптивным и отзывчивым дизайном",result:`
...
`},Xv={ques:" Разница между Progressive Enhancement и Graceful Degradation",result:`
...
`},Yv={ques:"Что такое Веб-компоненты и какие технологии в них используются",result:`
...
`},bv={ques:"RESTful api",result:`
	...
	его снова у сервера.
`},th={ques:"Принципы REST-архитектуры",result:`
...
`},nh={ques:"Разница между layout, painting и compositing",result:`
...
`},eh={ques:"Чем отличается dev-сборник от prod",result:`
...
`},rh={ques:"Что такое Flash Of Unstyled Content (FOUC)? Как его избежать",result:`
...
`},lh={ques:"History API в браузере",result:`
...
`},oh={ques:"Что такое codemod",result:`
...
`},ih={ques:"Что такое веб-хранилище (web storage)",result:`
...
`},uh={ques:"Разница между cookie, sessionStorage и localStorage",result:`
...
`},sh={ques:"Способы уменьшения времени загрузки веб-страницы",result:`
...
`},ah={ques:"Core Web Vitals и метрики",result:`
...
`},ch={ques:"Разница между preload, prefetch, preconnect и prerender",result:`
...
`},dh={ques:"Для чего нужен паттерн PRPL",result:`
...
`},ph={ques:"Из чего состоит HTTP-запрос",result:`
...
`},mh={ques:"Разница между HTTP и HTTPS",result:`
...
`},vh={ques:"Разница между HTTP/1 и HTTP/2",result:`
...
`},hh={ques:"Как работает мультиплексирование в HTTP/2",result:`
...
`},gh={ques:"Что такое “трехстороннее рукопожатие” (Triple handshake)",result:`
...
`},yh={ques:"Разница между PUT и POST-запросами",result:`
...
`},Sh={ques:"Разница между протоколами TCP и UDP",result:`
...
`},wh={ques:"Что такое WebSocket",result:`
...
`},kh={ques:"Разница между Long-Polling, Websockets и Server-Sent Events",result:`
...
`},Th={ques:"Как работает JSONP",result:`
...
`},_h={ques:"Что такое Service Workers",result:`
...
`},Ph={ques:"Что такое Web Workers",result:`
...
`},xh={ques:"Механизм установки сеанса между клиентом и сервером",result:`
...
`},Lh={ques:" Что такое IP-адрес",result:`
...
`},Mh={ques:"Разница между host и domain",result:`
...
`},Nh={ques:"Разница между URI и URL",result:`
...
`},Dh={ques:"Разница между монолитной и микросервисной архитектурами",result:`
...
`},$h={ques:"Опишите способы оптимизации SVG-файлов",result:`
...
`},qh={ques:"Сколько ресурсов браузер может одновременно загружать с одного домена",result:`
	Современные браузеры обычно поддерживают шесть одновременных соединений и 
	параллельных загрузок.
`},Oh={ques:"Что такое CORS",result:`
...
`},Ih={ques:"Для чего нужен CORS",result:`
...
`},zh={ques:"Что такое HTTP cookie",result:`
...
`},Hh={ques:"feature detection, feature inference и user-agent",result:`
...
`},jh={0:{ques:"Что такое HTTP cookie? Для чего они используются",result:`
...
`},lk:Av,ki:Fv,i:Uv,p:Wv,z:Jv,c:Bv,pt:Vv,o:Qv,d:Gv,m:Kv,g:Xv,w:Yv,r:Zv,f:bv,a:th,l:nh,jf:eh,u:rh,h:lh,cm:oh,v:ih,k:uh,s:sh,x:ah,j:ch,e:dh,t:fh,b:ph,n:mh,t2:vh,w2:hh,ts:gh,pu:yh,d2:Sh,ws:wh,dt:kh,jp:Th,in:{ques:"Что такое IndexedDB в браузере? Преимущества IndexedDB",result:`
...
`},sw:_h,ww:Ph,w5:Ch,dd:xh,ap:Eh,cd:Rh,ip:Lh,hd:Mh,ur:Nh,qq:Dh,sv:$h,dw:qh,bv:Oh,gg:Ih,cc:zh,ew:Hh},Ah={ques:"Что такое DOM?",result:`
...
`},Uh={ques:"Методы JavaScript для поиска элементов на странице",result:`
	1.querySelector
	2.querySelectorAll
	3.getElementById
	...
	6.getElementsByName  
`},Wh={ques:"Свойства для перемещения по dom-дереву",result:`
...
`},Bh={ques:"Виды событий Event?",result:`
...
`},Vh={ques:"media выражения в JavaScript",result:`
...
`},Qh={ques:"event.target и event.currentTarget",result:`
...
`},Gh={ques:"события load и DOMContentLoaded",result:`
...
`},Kh={ques:"Метод EventTarget.addEventListener()",result:`
...
`},Yh={ques:"Как узнать об использовании метода event.preventDefault()?",result:`
...
`},Zh={ques:"Intersection Observer",result:`
...
`},eg={ques:"Разница между function declaration и function expression",result:`
...
`},rg={ques:"Типы таймеров в JavaScript",result:`
...
`},lg={ques:"Поднятие (Hoisting)",result:`
...
`},og={ques:"Область видимости (Scope)",result:`
...
`},sg={ques:"Что такое чистая функция",result:`
...
`},ag={ques:"Почему в JS функции называют объектами первого класса",result:`
...
`},cg={ques:"Псевдомассив arguments",result:`
...
`},dg={ques:"Разница между host-объектами и нативными объектами",result:`
	...
	в любом окружении.
`},fg={ques:"События указателя (Pointer Events)",result:`
...
`},pg={ques:"Прототипное наследование",result:`
...
`},vg={ques:"Объектная обертка (Wrapper Objects)",result:`
...
`},hg={ques:"Проверить, является ли значение массивом",result:`
	Array.isArray(yourVariable)
	val.constructor === Array
	Object.prototype.toString.call(val) === '[object Array]'
`},gg={ques:"boxing/unboxing",result:`
...
`},yg={ques:"Разница между оператором in и методом .hasOwnProperty()",result:`
...
`},Sg={ques:"Разница между глубокой (deep) и поверхностной (shallow) копиями",result:`
	...
	Для создания глубокой копии объекта:
		...
		-Рекурсивно
		-Библиотеки
`},wg={ques:"Цепочка вызовов функций (chaining)",result:`
...
`},kg={ques:"Что такое необъявленная переменная",result:`
...
`},_g={ques:"Что такое прототип объекта в JavaScript",result:`
...
`},Pg={ques:"Как работает метод Object.create()",result:`
...
`},Cg={ques:"Object.freeze() и Object.seal()",result:`
...
`},xg={ques:"Плюсы и минусы использования use strict",result:`
	Плюсы:
...
`},Eg={ques:"Плюсы и минусы иммутабельности",result:`
	Плюсы:
...
`},Rg={ques:"Типы ОБЪЕКТОВ JavaScript",result:`
	-Строковые объекты.
	-Числовые объекты
	-Логические объекты
	-Объектные литералы
	-Массивы 
`},Lg={ques:"Типы ошибок в JavaScript",result:`
...
`},Mg={ques:"Разница между typeof и instanceof?",result:`
...
`},Ng={ques:"JavaScript статически, или динамически типизированный язык",result:`
...
`},Dg={ques:"Регулярное выражение (Regular Expression)",result:`
...
`},$g={ques:"Что такое полифил (polyfill)",result:`
...
`},qg={ques:"expression и statement",result:`
...
`},Og={ques:"Типы утечек памяти в JavaScript",result:`
...
`},Ig={ques:"Разница между примитивом и объектом",result:`
...
`},zg={ques:"Почему typeof null возвращает object",result:`
...
`},jg={ques:"Разница между синхронными и асинхронными функциями",result:`
...
`},Fg={ques:"Что такое same-origin policy в контексте JavaScript",result:`
...
`},Ug={ques:"Разница между микро и макрозадачами в event loop",result:`
...
`},Wg={ques:"Что такое промисы (Promises)",result:`
...
`},Jg={ques:"В каких состояниях может пребывать Promise)",result:`
...
`},Bg={ques:"Плюсы и минусы использовании Ajax",result:`
	Плюсы:
...
`},Vg={ques:"Подходы при работе с асинхронным кодом",result:`
...
`},Qg={ques:"Преимущества использовании промисов вместо колбэков",result:`
...
`},Gg={ques:"Что такое callback-функция? Что такое Callback Hell",result:`
...
`},Kg={ques:"Что такое async/await",result:`
...
`},Xg={ques:"Плюсы и минусы асинхронного программирования",result:`
	Плюсы:
...
`},Yg={ques:"Что такое генераторы? Когда стоит использовать генераторы",result:`
...
`},Zg={ques:"Что такое дескрипторы свойств объектов",result:`
...
`},bg={ques:" В чем заключаются особенности геттеров и сеттеров",result:`
...
`},ty={ques:"WeakMap и WeakSet",result:`
...
`},ny={ques:"Что такое temporal dead zone",result:`
...
`},ey={0:{ques:"Разница между null и undefined",result:`
...
`},i:Ah,n:Fh,m:Uh,c:Wh,b:Jh,e:Bh,s:Vh,t:Qh,l:Gh,q:Kh,x:Xh,h:Yh,o:Zh,u:bh,td:tg,st:ng,f:eg,ti:rg,p:lg,sc:og,z:ig,th:ug,mn:sg,fc:ag,pm:cg,hn:dg,pe:fg,pl:pg,na:mg,w:vg,ar:hg,bu:gg,ih:yg,ds:Sg,ch:wg,uv:kg,af:Tg,po:_g,oc:Pg,fs:Cg,ms:xg,im:Eg,to:Rg,er:Lg,tt:Mg,sd:Ng,re:Dg,pf:$g,es:qg,lm:Og,ob:Ig,no:zg,pr:Hg,as:jg,aj:Ag,sp:Fg,ma:Ug,ps:Wg,yt:Jg,da:Bg,ac:Vg,pp:Qg,cf:Gg,aa:Kg,p0:Xg,g:Yg,k:Zg,q1:bg,wm:ty,tz:ny},ry={ques:"Основные принципы ООП",result:`
...
`},ly={ques:"Что такое SOLID",result:`
...
`},oy={ques:"Разница между классовым и прототипным наследованием",result:`
...
`},iy={ques:"Однонаправленный поток данных и двусторонняя связь данных",result:`
...
`},sy={ques:"Что такое каррирование (Currying)",result:`
...
`},ay={ques:"Статический метод класса (static)",result:`
...
`},cy={ques:"Типы паттернов в ООП",result:`
...
`},dy={ques:"Как работает механизм прототипов в JavaScript",result:`
...
`},fy={ques:"Разница между императивным и декларативным подходами программирования",result:`
...
`},py={ques:"Что такое реактивное программирование",result:`
...
`},my={ques:"Разница между агрегацией и композицией",result:`
...
`},vy={i:ry,s:ly,p:oy,d:iy,m:uy,k:sy,t:ay,n:cy,v:dy,x:fy,r:py,e:my},hy={ques:"Виды тестирования",result:`
...
`},gy={ques:"Fake в unit тестировании",result:`
...
`},yy={ques:"Stub в unit тестировании",result:`
...
`},Sy={ques:"Mock в unit тестировании?",result:`
...
`},wy={ques:"White/Black/Grey Box-тестирование?",result:`
...
`},ky={ques:"Что такое Quality Gates",result:`
...
`},Ty={ques:"Разница между TDD и BDD",result:`
...
`},_y={ques:"UI-тестирование",result:`
...
`},Py={ques:"Как можно оценить качество тестирования",result:`
...
`},Cy={ques:"Принцип FIRST в тестировании",result:`
...
`},xy={v:hy,f:gy,s:yy,m:Sy,b:wy,g:ky,t:Ty,u:_y,e:Py,i:Cy},Ey={ques:"Метрики в программировании",result:`
...
`},Ny={m:Ey,i:Ry,e:Ly,p:My},Dy={ques:"Что такое vue?",result:"vue - это ..."},$y={e:Dy},Dr={html:Rp,css:_m,methodology:Ny,react:vv,type_script:jv,web:jh,java_script:ey,git:Xp,oop:vy,testing:xy,vue:$y},qy=Object.keys(Dr),Wo={html:"HTML и вёрстка",git:"GIT",css:"CSS и препроцессоры",methodology:"Методология",react:"React",type_script:"TypeScript",java_script:"JavaScript",oop:"ООП",testing:"Тестирование",web:"Web",vue:"Vue"},Oy=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>{const e=r=>{r.target.tagName==="BUTTON"&&(t(r.target.id),n(!1))};return D.jsx("div",{className:Xu.dropDown,children:D.jsx("ul",{className:Xu.dropDown_list,onClick:e,children:qy.map(r=>D.jsx("li",{children:D.jsx(cc,{text:Wo[r],id:r,position:"menu"})},Wo[r]))})})}),Iy=vt.memo(({setWindowContentName:t,setIsActiveMenu:n})=>D.jsx("div",{className:Ku.menu_nav,children:D.jsx("ul",{className:Ku.menu_nav_list,children:D.jsx(Oy,{setWindowContentName:t,setIsActiveMenu:n})})})),zy="_list_ques_91ie3_1",Hy="_window_content__answer_91ie3_5",jy="_window_content_91ie3_5",Ay="_window_content__text_91ie3_20",Fy="_title_page_91ie3_30",Uy="_input_search_91ie3_36",Wy="_input_search_input_91ie3_41",Jy="_not_matches_91ie3_53",By="_button_back_91ie3_58",At={list_ques:zy,window_content__answer:Hy,window_content:jy,window_content__text:Ay,title_page:Fy,input_search:Uy,input_search_input:Wy,not_matches:Jy,button_back:By},Vy=(t,n)=>{const e=t.toLowerCase().trim(),r=[];for(let[l,o]of Object.entries(n))for(let[i,u]of Object.entries(o))JSON.stringify(u).toLowerCase().indexOf(e)!=-1&&r.push([i,u,l]);return r},Qy=(t,n=300)=>{let e=null;return(...r)=>{window.clearTimeout(e),e=setTimeout(()=>{t(...r)},n)}};function Gy({windowContentName:t,setIsActiveMenu:n,setWindowContentName:e}){const[r,l]=vt.useState(null),[o,i]=vt.useState(""),[u,s]=vt.useState(0),d=Qy(y=>{if(y.target){const S=y.target.value.trim().toLowerCase();i(S)}},800),v=()=>{l(null),n(!1),setTimeout(()=>window.scrollTo(0,u),0)},m=vt.useMemo(()=>{const y=w=>{const $=w.target.parentElement.getAttribute("data-name");if($&&e($),w.target.id){s(window.scrollY);const c=w.target.id;l(c),window.scrollTo(0,0)}},S=o?Vy(o,Dr):Object.entries(Dr[t]);return D.jsx(kr.Fragment,{children:S.length>0?D.jsx("ol",{className:At.list_ques,onClick:y,children:S.map((w,$)=>{var c;return D.jsx("li",{"data-name":w[2]?w[2]:"",children:D.jsx(cc,{id:w[0],text:(c=w[1])==null?void 0:c.ques})},w[0]+$)})}):D.jsx("div",{className:At.not_matches,children:"Совпадений не найдено"})})},[t,o]),p=vt.useMemo(()=>{var S;const y=Dr[t];if(r)return D.jsxs("article",{className:At.window_content__answer,children:[D.jsx("h1",{children:(S=y==null?void 0:y[r])==null?void 0:S.ques}),D.jsx("div",{className:At.window_content__text,children:D.jsx("p",{children:y==null?void 0:y[r].result})})]})},[t,r]);return D.jsxs("div",{className:At.window_content,children:[!r&&D.jsxs(kr.Fragment,{children:[D.jsx("div",{className:At.input_search,children:D.jsx("input",{className:At.input_search_input,type:"text",onChange:d,placeholder:"Поиск по содержимому всех тем"})}),D.jsx("h1",{className:At.title_page,children:o?"Результат поиска":Wo[t]})]}),r?D.jsxs(kr.Fragment,{children:[D.jsx("button",{className:At.button_back,onClick:v,children:"BACK"}),p]}):m]})}function Ky(){const[t,n]=vt.useState(""),[e,r]=vt.useState(!0),l=()=>{r(!0),n("")};return D.jsx("main",{children:D.jsxs("div",{className:Gu.wrapper,children:[D.jsx("button",{onClick:l,className:Gu.open_menu,children:"MENU"}),!!t&&D.jsx(Gy,{windowContentName:t,setWindowContentName:n,setIsActiveMenu:r}),e&&D.jsx(Iy,{setWindowContentName:n,setIsActiveMenu:r})]})})}Kl.createRoot(document.getElementById("root")).render(D.jsx(kr.StrictMode,{children:D.jsx(Ky,{})}));
